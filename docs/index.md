...
---
# PR Hygiene Report
*Last updated: 2026-05-22 18:40 UTC · commit fe9fdc4*

## Summary
- Open PRs: **60** (5 clean · 0 CI failing · 11 changes requested · 8 unresolved comments · 9 deferred · 14 draft · 13 stale)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [12+(8)](#lklimek-open) | [3+(0)](#lklimek-clean) | — | [1+(2)](#lklimek-unresolved-comments) | [2+(2)](#lklimek-changes-requested) | [5+(0)](#lklimek-deferred) | — | [1+(4)](#lklimek-stale) | [3+(4)](#lklimek-needs-action) | [1+(41)](#lklimek-unresolved-comments) | — |
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [8+(10)](#pastapastapasta-open) | [1+(0)](#pastapastapasta-clean) | — | [3+(0)](#pastapastapasta-unresolved-comments) | [0+(1)](#pastapastapasta-changes-requested) | — | [4+(7)](#pastapastapasta-draft) | [0+(2)](#pastapastapasta-stale) | [3+(1)](#pastapastapasta-needs-action) | [3+(4)](#pastapastapasta-unresolved-comments) | — |
| [@QuantumExplorer](#quantumexplorer) | [4](#quantumexplorer-open) | — | — | [1](#quantumexplorer-unresolved-comments) | — | [2](#quantumexplorer-deferred) | [1](#quantumexplorer-draft) | — | [1](#quantumexplorer-needs-action) | [11](#quantumexplorer-unresolved-comments) | [4](#quantumexplorer-ready-for-review) |
...
| [@shumkov](#shumkov) | [5](#shumkov-open) | — | — | — | [2](#shumkov-changes-requested) | [1](#shumkov-deferred) | — | [2](#shumkov-stale) | [2](#shumkov-needs-action) | — | [1](#shumkov-ready-for-review) |
| [@ZocoLini](#zocolini) | [4](#zocolini-open) | [1](#zocolini-clean) | — | — | [2](#zocolini-changes-requested) | — | [1](#zocolini-draft) | — | [2](#zocolini-needs-action) | — | — |
...
- [#3672 feat(platform-wallet): keyring_core secret backends — encrypted-file + OS keyring (secrets feature)](https://github.com/dashpay/platform/pull/3672) — via @Claudius-Maginificent · 14 unresolved (14 human) · 0 days stale · ⚠ merge conflict · ✋ changes requested · 🐢 targets feat/platform-wallet-sqlite-persistor
  - Top thread: "`SecretString::drop` creates a `&mut [u8\]` over the entire `String` capacity via `from_raw_parts_mut(ptr, cap)`. The byt…" — 0 days old
- [#3637 feat(platform-wallet): serde support](https://github.com/dashpay/platform/pull/3637) — via @Claudius-Maginificent · 5 unresolved (1 CodeRabbit, 4 human) · 9 days stale · ⚠ merge conflict
  - Top thread: "_⚠️ Potential issue_ \| _🔴 Critical_" — 8 days old
- [#3625 feat(platform-wallet): add platform-wallet-storage crate (sqlite persister)](https://github.com/dashpay/platform/pull/3625) — via @Claudius-Maginificent · 2 unresolved (2 CodeRabbit) · 0 days stale · 🔴 CI failing
  - Top thread: "_⚠️ Potential issue_ \| _🟠 Major_ \| _⚡ Quick win_" — 0 days old
- [#3721 test(rs-sdk): relocate DPNS network tests from src/ to tests/](https://github.com/dashpay/platform/pull/3721) — 1 unresolved (1 CodeRabbit) · 0 days stale
  - Top thread: "_⚠️ Potential issue_ \| _🟠 Major_ \| _⚡ Quick win_" — 0 days old
...
- [#3725 feat(drive): add document history retrieval](https://github.com/dashpay/platform/pull/3725) — 1 unresolved (1 CodeRabbit) · 1 days stale · ✋ changes requested
  - Top thread: "_⚠️ Potential issue_ \| _🟠 Major_ \| _🏗️ Heavy lift_" — 1 days old
- [#2988 feat(wasm-sdk): auto-generate entropy for document creation when not provided](https://github.com/dashpay/platform/pull/2988) — 1 unresolved (1 human) · 1 days stale · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=30cbefe1c9ef -->" — 1 days old
...
- [#3728 ci: pin book TypeDoc build to Node 22](https://github.com/dashpay/platform/pull/3728) — via @thepastaclaw · 📝 draft
...
- [#3729 chore: bump rust-dashcore to rev f569e7b7b99dfe589c41f9ba7d36fbbe6805acdc](https://github.com/dashpay/platform/pull/3729) — by @ZocoLini
...
- [#3729 chore: bump rust-dashcore to rev f569e7b7b99dfe589c41f9ba7d36fbbe6805acdc](https://github.com/dashpay/platform/pull/3729)
...
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 478 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v2.0-dev, untouched 468 days
  - Top thread: "_:warning: Potential issue_" — 478 days old
