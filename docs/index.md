...
---
# PR Hygiene Report
*Last updated: 2026-05-29 00:51 UTC · commit 744060e*
...
#### Open (17)
- [#3096 feat(sdk): add client-side validation to state transition construction methods](https://github.com/dashpay/platform/pull/3096) — via @thepastaclaw · 4 unresolved (2 CodeRabbit, 2 human) · 100 days stale · ⚠ merge conflict · 📝 draft
...
<a id="shumkov-open"></a>
#### Open (6)
- [#3764 feat(dashmate): configure docker build args via config](https://github.com/dashpay/platform/pull/3764) — 4 unresolved (3 CodeRabbit, 1 human) · 0 days stale · ✋ changes requested · 🔴 CI failing
...
<a id="lklimek-open"></a>
#### Open (15)
- [#3625 feat(platform-wallet): add platform-wallet-storage crate (sqlite persister)](https://github.com/dashpay/platform/pull/3625) — via @Claudius-Maginificent · 41 unresolved (4 CodeRabbit, 37 human) · 3 days stale
...
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 484 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v2.0-dev, untouched 475 days
