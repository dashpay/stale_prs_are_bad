...
---
# PR Hygiene Report
*Last updated: 2026-07-06 13:17 UTC · commit 4d0cadf*

## Summary
- Open PRs: **53** (8 clean · 2 CI failing · 2 changes requested · 12 unresolved comments · 10 deferred · 10 draft · 9 stale)
...
| [@ZocoLini](#zocolini) | [6](#zocolini-open) | [4](#zocolini-clean) | — | [1](#zocolini-unresolved-comments) | [1](#zocolini-changes-requested) | — | — | — | [3](#zocolini-needs-action) | [2](#zocolini-unresolved-comments) | — | ↑ 2 |
| [@shumkov](#shumkov) | [5](#shumkov-open) | — | — | [1](#shumkov-unresolved-comments) | [1](#shumkov-changes-requested) | [2](#shumkov-deferred) | [1](#shumkov-draft) | — | [2](#shumkov-needs-action) | [3](#shumkov-unresolved-comments) | [1](#shumkov-ready-for-review) | ↓ 1 |
...
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [5+(7)](#lklimek-open) | [0+(1)](#lklimek-clean) | [0+(1)](#lklimek-ci-failing) | — | — | [5+(0)](#lklimek-deferred) | [0+(2)](#lklimek-draft) | [0+(3)](#lklimek-stale) | [0+(1)](#lklimek-needs-action) | [0+(29)](#lklimek-unresolved-comments) | [1+(0)](#lklimek-ready-for-review) | ↓ 1 |
...
- [#3981 feat(platform-wallet): pure transaction decoder + thin FFI/Swift wrappers](https://github.com/dashpay/platform/pull/3981) — 2 unresolved (2 human) · 3 days stale · ✋ changes requested · 🔴 CI failing
...
#### Open (6)
- [#3970 refactor(platform-wallet): expose the new core TransactionBuilder API](https://github.com/dashpay/platform/pull/3970) — 2 unresolved (2 human) · 0 days stale · ✋ changes requested · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=17aff0d29393 dedupe=e142f1dfc6fb7336 -->" — 0 days old
...
<a id="lklimek-open"></a>
#### Open (12)
- [#3549 test(platform-wallet): e2e framework + full test suite — triage pins, Found-*/PA-* guards, fail-closed persist, Stage-2 merge](https://github.com/dashpay/platform/pull/3549) — via @Claudius-Maginificent · 20 unresolved (20 human) · 65 days stale · ⚠ merge conflict · 📝 draft
...
- [#3986 feat(platform-wallet-storage): snapshot readers + unified V002 schema migration](https://github.com/dashpay/platform/pull/3986) — via @Claudius-Maginificent · 4 unresolved (4 human) · 3 days stale · ⚠ merge conflict · 🔴 CI failing · 🐢 targets feat/platform-wallet-storage-rehydration
