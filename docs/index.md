...
---
# PR Hygiene Report
*Last updated: 2026-07-26 06:57 UTC · commit b106b79*
...
- [#4222 fix(platform): harden v12 to v13 protocol upgrades](https://github.com/dashpay/platform/pull/4222) — 2 unresolved (2 human) · 2 days stale · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=afb6198d59b1 dedupe=5a34fce89f7fb74d -->" — 2 days old
...
#### Open (1)
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 543 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v2.0-dev, untouched 533 days
