...
---
# PR Hygiene Report
*Last updated: 2026-05-27 07:30 UTC · commit a272464*

## Summary
- Open PRs: **63** (3 clean · 0 CI failing · 10 changes requested · 10 unresolved comments · 9 deferred · 16 draft · 15 stale)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [8+(11)](#pastapastapasta-open) | — | — | [5+(0)](#pastapastapasta-unresolved-comments) | [0+(1)](#pastapastapasta-changes-requested) | — | [3+(8)](#pastapastapasta-draft) | [0+(2)](#pastapastapasta-stale) | [5+(1)](#pastapastapasta-needs-action) | [9+(5)](#pastapastapasta-unresolved-comments) | — | ↑ 3 |
| [@QuantumExplorer](#quantumexplorer) | [7](#quantumexplorer-open) | [1](#quantumexplorer-clean) | — | [2](#quantumexplorer-unresolved-comments) | [1](#quantumexplorer-changes-requested) | [2](#quantumexplorer-deferred) | [1](#quantumexplorer-draft) | — | [3](#quantumexplorer-needs-action) | [16](#quantumexplorer-unresolved-comments) | [2](#quantumexplorer-ready-for-review) | — |
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [8+(10)](#lklimek-open) | [2+(0)](#lklimek-clean) | — | [0+(1)](#lklimek-unresolved-comments) | [0+(2)](#lklimek-changes-requested) | [5+(0)](#lklimek-deferred) | [0+(1)](#lklimek-draft) | [1+(6)](#lklimek-stale) | [0+(3)](#lklimek-needs-action) | [0+(36)](#lklimek-unresolved-comments) | — | ↓ 7 |
| [@shumkov](#shumkov) | [6](#shumkov-open) | — | — | [1](#shumkov-unresolved-comments) | [1](#shumkov-changes-requested) | [1](#shumkov-deferred) | [1](#shumkov-draft) | [2](#shumkov-stale) | [2](#shumkov-needs-action) | [6](#shumkov-unresolved-comments) | [2](#shumkov-ready-for-review) | ↑ 1 |
...
| [@ZocoLini](#zocolini) | [4](#zocolini-open) | — | — | — | [3](#zocolini-changes-requested) | — | [1](#zocolini-draft) | — | [3](#zocolini-needs-action) | [30](#zocolini-unresolved-comments) | — | ↑ 1 |
...
#### Open (19)
- [#3096 feat(sdk): add client-side validation to state transition construction methods](https://github.com/dashpay/platform/pull/3096) — via @thepastaclaw · 4 unresolved (2 CodeRabbit, 2 human) · 98 days stale · 📝 draft
  - Top thread: "_⚠️ Potential issue_ \| _🟡 Minor_" — 95 days old
- [#3509 fix(platform): default omitted proved query limits](https://github.com/dashpay/platform/pull/3509) — 1 unresolved (1 human) · 24 days stale · ✋ changes requested · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=d3df3e197206 -->" — 24 days old
- [#3725 feat(drive): add document history retrieval](https://github.com/dashpay/platform/pull/3725) — 1 unresolved (1 CodeRabbit) · 6 days stale · ✋ changes requested
  - Top thread: "_⚠️ Potential issue_ \| _🟠 Major_ \| _🏗️ Heavy lift_" — 6 days old
- [#3748 feat(wasm-sdk): first-class devnet support with trusted-context prefetch](https://github.com/dashpay/platform/pull/3748) — 4 unresolved (4 human) · 0 days stale · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=d14f50bd74b9 -->" — 0 days old
- [#3680 refactor(dapi,dpp)!: move dapi-client and Identifier off Buffer to Uint8Array](https://github.com/dashpay/platform/pull/3680) — 2 unresolved (2 human) · 0 days stale
  - Top thread: "<!-- thepastaclaw-review v1 finding=1c101f507542 -->" — 0 days old
- [#2988 feat(wasm-sdk): auto-generate entropy for document creation when not provided](https://github.com/dashpay/platform/pull/2988) — 1 unresolved (1 human) · 6 days stale · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=30cbefe1c9ef -->" — 6 days old
- [#3734 feat(rs-sdk-ffi): expose SDK protocol version pinning](https://github.com/dashpay/platform/pull/3734) — via @thepastaclaw · 1 unresolved (1 human) · 2 days stale · 📝 draft
  - Top thread: "The Python example updates the call to `dash_sdk_create_with_protocol_version`, but the `DashSDKConfig` ctypes definitio…" — 2 days old
...
#### Open (7)
- [#3557 feat(platform-wallet): instrument wallet_manager RwLock behind lock-stats feature](https://github.com/dashpay/platform/pull/3557) — 11 unresolved (2 CodeRabbit, 9 human) · 29 days stale · ⚠ merge conflict
  - Top thread: "_⚠️ Potential issue_ \| _🟠 Major_" — 29 days old
- [#3740 feat: add time-range indexes for trending/leaderboard queries](https://github.com/dashpay/platform/pull/3740) — 5 unresolved (5 CodeRabbit) · 2 days stale · ✋ changes requested · 🔴 CI failing
...
<a id="lklimek-open"></a>
#### Open (18)
- [#3549 test(platform-wallet): e2e framework + full test suite — triage pins, Found-*/PA-* guards, fail-closed persist, Stage-2 merge](https://github.com/dashpay/platform/pull/3549) — via @Claudius-Maginificent · 20 unresolved (20 human) · 24 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets fix/rs-platform-wallet-auto-select-inputs
  - Top thread: "<!-- thepastaclaw-review v1 finding=a3725e9d50ca -->" — 24 days old
- [#3625 feat(platform-wallet): add platform-wallet-storage crate (sqlite persister)](https://github.com/dashpay/platform/pull/3625) — via @Claudius-Maginificent · 10 unresolved (6 CodeRabbit, 4 human) · 2 days stale · ✋ changes requested · 🔴 CI failing
  - Top thread: "README lists a `delete-wallet` CLI subcommand, but the actual CLI (src/bin/platform-wallet-storage.rs) does not define t…" — 2 days old
- [#3672 feat(platform-wallet): keyring_core secret backends — encrypted-file + OS keyring (secrets feature)](https://github.com/dashpay/platform/pull/3672) — via @Claudius-Maginificent · 6 unresolved (6 human) · 1 days stale · ✋ changes requested · 🐢 targets feat/platform-wallet-sqlite-persistor
  - Top thread: "<!-- thepastaclaw-review v1 finding=b2f578268729 -->" — 1 days old
...
- [#3585 fix: case-insensitive .dash + wallet concurrency hardening (UTXO and receive-address races)](https://github.com/dashpay/platform/pull/3585) — via @Claudius-Maginificent · ✋ changes requested
...
- [#3743 feat(platform-wallet)!: rs-platform-wallet-storage crate (SQLite persister) + trait surface](https://github.com/dashpay/platform/pull/3743) — via @Claudius-Maginificent · 📝 draft · 🐢 targets feat/platform-wallet-sqlite-persistor
- [#3750 feat(platform-wallet)!: consumer hardening — CODE-001/003-callsite/017/018 + PROJ-001 FFI + CODE-008/012/013](https://github.com/dashpay/platform/pull/3750) — via @Claudius-Maginificent · 📝 draft · 🐢 targets fix/3625-thepastaclaw-hardening
...
<a id="shumkov-open"></a>
#### Open (6)
- [#3671 feat: platform-address funding from asset-lock proofs](https://github.com/dashpay/platform/pull/3671) — 6 unresolved (6 human) · 0 days stale · ✋ changes requested
  - Top thread: "<!-- thepastaclaw-review v1 finding=fc557c547a45 -->" — 0 days old
...
- [#3732 [DON'T MERGE\] feat(drive-abci,dashmate): seed Orchard shielded pool at SDK_TEST_DATA devnet genesis](https://github.com/dashpay/platform/pull/3732) — ⚠ merge conflict · 🔴 CI failing · 📝 draft
...
#### Open (1)
- [#3162 fix(dashmate): prevent orphaned verification container blocking SSL renewal](https://github.com/dashpay/platform/pull/3162) — 6 unresolved (6 human) · 8 days stale
  - Top thread: "<!-- thepastaclaw-review v1 finding=d7ee272d2ab4 dedupe=d8f79f6f47c868dc -->" — 8 days old
...
#### Open (4)
- [#3712 test(swift-sdk): first swift sdk integration tests with local network](https://github.com/dashpay/platform/pull/3712) — 30 unresolved (6 CodeRabbit, 24 human) · 0 days stale · 📝 draft
...
#### Open (3)
- [#3481 feat(swift-sdk): expose rich transaction fields in WalletTransaction](https://github.com/dashpay/platform/pull/3481) — 1 unresolved (1 CodeRabbit) · 44 days stale · ⚠ merge conflict · 🔴 CI failing · 📝 draft
...
#### Open (4)
- [#2444 feat(sdk): add NFT actions in the JS Dash SDK](https://github.com/dashpay/platform/pull/2444) — 17 unresolved (5 CodeRabbit, 12 human) · 454 days stale · ⚠ merge conflict · ✋ changes requested · 🐢 targets v2.0-dev
  - Top thread: "_:warning: Potential issue_" — 454 days old
- [#2465 fix(sdk): replace seeds with ip address](https://github.com/dashpay/platform/pull/2465) — 7 unresolved (7 human) · 464 days stale · ✋ changes requested · 🐢 targets master
  - Top thread: "Why do we use testnet seeds for mainnet?" — 464 days old
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 483 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v2.0-dev, untouched 473 days
  - Top thread: "_:warning: Potential issue_" — 483 days old
