...
---
# PR Hygiene Report
*Last updated: 2026-06-14 07:39 UTC · commit dee67d9*

## Summary
- Open PRs: **51** (7 clean · 3 CI failing · 2 changes requested · 12 unresolved comments · 10 deferred · 13 draft · 4 stale)
...
| [@QuantumExplorer](#quantumexplorer) | [9](#quantumexplorer-open) | [3](#quantumexplorer-clean) | — | [2](#quantumexplorer-unresolved-comments) | — | [2](#quantumexplorer-deferred) | [2](#quantumexplorer-draft) | — | [2](#quantumexplorer-needs-action) | [17](#quantumexplorer-unresolved-comments) | [4](#quantumexplorer-ready-for-review) | ↓ 1 |
| [@llbartekll](#llbartekll) | [3](#llbartekll-open) | — | [1](#llbartekll-ci-failing) | [2](#llbartekll-unresolved-comments) | — | — | — | — | [2](#llbartekll-needs-action) | [3](#llbartekll-unresolved-comments) | [4](#llbartekll-ready-for-review) | — |
...
- [#3890 feat: record DAPI address ban reason and expose via platform-wallet FFI](https://github.com/dashpay/platform/pull/3890)
- [#3891 feat(swift-example-app): add identity→identity Transfer Credits production UI](https://github.com/dashpay/platform/pull/3891)
- [#3892 fix(rs-sdk-ffi): don't export ContestedResourceVoteChoiceFFI to the C header](https://github.com/dashpay/platform/pull/3892)
...
#### Ready for Review (4)
- [#3778 ci(swift-sdk): remove swift-sdk artifact upload](https://github.com/dashpay/platform/pull/3778) — by @ZocoLini
- [#3890 feat: record DAPI address ban reason and expose via platform-wallet FFI](https://github.com/dashpay/platform/pull/3890) — by @QuantumExplorer
- [#3891 feat(swift-example-app): add identity→identity Transfer Credits production UI](https://github.com/dashpay/platform/pull/3891) — by @QuantumExplorer
- [#3892 fix(rs-sdk-ffi): don't export ContestedResourceVoteChoiceFFI to the C header](https://github.com/dashpay/platform/pull/3892) — by @QuantumExplorer
