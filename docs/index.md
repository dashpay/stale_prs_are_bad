...
---
# PR Hygiene Report
*Last updated: 2026-08-06 06:57 UTC · commit ec78dbf*

## Summary
- Open PRs: **59** (7 clean · 0 CI failing · 2 changes requested · 27 unresolved comments · 11 deferred · 8 draft · 4 stale)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@bfoss765](#bfoss765) | [12](#bfoss765-open) | [1](#bfoss765-clean) | — | [10](#bfoss765-unresolved-comments) | — | — | — | [1](#bfoss765-stale) | [11](#bfoss765-needs-action) | [45](#bfoss765-unresolved-comments) | — | ↑ 1 |
...
| [@shumkov](#shumkov) | [11](#shumkov-open) | [2](#shumkov-clean) | — | [3](#shumkov-unresolved-comments) | [1](#shumkov-changes-requested) | [2](#shumkov-deferred) | [3](#shumkov-draft) | — | [5](#shumkov-needs-action) | [9](#shumkov-unresolved-comments) | [3](#shumkov-ready-for-review) | ↑ 1 |
| [@QuantumExplorer](#quantumexplorer) | [7](#quantumexplorer-open) | [1](#quantumexplorer-clean) | — | [2](#quantumexplorer-unresolved-comments) | [1](#quantumexplorer-changes-requested) | [3](#quantumexplorer-deferred) | — | — | [3](#quantumexplorer-needs-action) | [10](#quantumexplorer-unresolved-comments) | [2](#quantumexplorer-ready-for-review) | — |
...
- [#4315 fix(platform-wallet): lossless mpsc persistence drain — root-cause fix for the sync-watermark freeze](https://github.com/dashpay/platform/pull/4315) — 3 unresolved (3 human) · 0 days stale · ✋ changes requested · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=30c2e8e95003 dedupe=d6140bc9d29121d2 -->" — 0 days old
- [#4308 feat(kotlin-sdk): split build/broadcast with reservation release for BIP70-style deferred submission](https://github.com/dashpay/platform/pull/4308) — 6 unresolved (1 CodeRabbit, 5 human) · 0 days stale · ⚠ merge conflict
  - Top thread: "_📐 Maintainability & Code Quality_ \| _🟡 Minor_ \| _⚡ Quick win_" — 0 days old
- [#4313 feat(kotlin-sdk): one-time Orchard key shielded-invite API (inviter + claim)](https://github.com/dashpay/platform/pull/4313) — 4 unresolved (3 CodeRabbit, 1 human) · 0 days stale · ✋ changes requested
...
- [#4314 fix(platform-wallet): batch wallet-event persistence + expose sync_fault (watermark-freeze mitigations)](https://github.com/dashpay/platform/pull/4314) — 1 unresolved (1 human) · 0 days stale
  - Top thread: "<!-- thepastaclaw-review v1 finding=85e495c3eacd dedupe=06d58a3d06aa3ad4 -->" — 0 days old
...
- [#4309 fix(platform-wallet): age-guard the V2 finalized-transaction handle broadcast](https://github.com/dashpay/platform/pull/4309) — 🐢 targets port/v4.1/split-build-broadcast
...
- [#4282 fix(dashmate)!: give Debian packages versions apt can order](https://github.com/dashpay/platform/pull/4282) — 3 unresolved (1 CodeRabbit, 2 human) · 2 days stale · 🔴 CI failing
