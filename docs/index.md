...
---
# PR Hygiene Report
*Last updated: 2026-05-28 07:25 UTC · commit 6c73c62*

## Summary
- Open PRs: **59** (3 clean · 0 CI failing · 10 changes requested · 8 unresolved comments · 9 deferred · 16 draft · 13 stale)
...
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [8+(8)](#lklimek-open) | [2+(0)](#lklimek-clean) | — | [0+(1)](#lklimek-unresolved-comments) | [0+(1)](#lklimek-changes-requested) | [5+(0)](#lklimek-deferred) | [0+(2)](#lklimek-draft) | [1+(4)](#lklimek-stale) | [0+(2)](#lklimek-needs-action) | [0+(38)](#lklimek-unresolved-comments) | — | ↓ 7 |
...
- [#3509 fix(platform): default omitted proved query limits](https://github.com/dashpay/platform/pull/3509) — 1 unresolved (1 human) · 25 days stale · ✋ changes requested · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=d3df3e197206 -->" — 25 days old
...
- [#3680 refactor(dapi,dpp)!: move dapi-client and Identifier off Buffer to Uint8Array](https://github.com/dashpay/platform/pull/3680) — 2 unresolved (2 human) · 1 days stale
  - Top thread: "<!-- thepastaclaw-review v1 finding=1c101f507542 -->" — 1 days old
...
<a id="lklimek-open"></a>
#### Open (16)
- [#3549 test(platform-wallet): e2e framework + full test suite — triage pins, Found-*/PA-* guards, fail-closed persist, Stage-2 merge](https://github.com/dashpay/platform/pull/3549) — via @Claudius-Maginificent · 20 unresolved (20 human) · 25 days stale · ⚠ merge conflict · 📝 draft
  - Top thread: "<!-- thepastaclaw-review v1 finding=a3725e9d50ca -->" — 25 days old
- [#3625 feat(platform-wallet): add platform-wallet-storage crate (sqlite persister)](https://github.com/dashpay/platform/pull/3625) — via @Claudius-Maginificent · 10 unresolved (10 human) · 3 days stale · 🔴 CI failing
  - Top thread: "README lists a `delete-wallet` CLI subcommand, but the actual CLI (src/bin/platform-wallet-storage.rs) does not define t…" — 3 days old
- [#3672 feat(platform-wallet): keyring_core secret backends — encrypted-file + OS keyring (secrets feature)](https://github.com/dashpay/platform/pull/3672) — via @Claudius-Maginificent · 8 unresolved (8 human) · 1 days stale · 🐢 targets feat/platform-wallet-sqlite-persistor
  - Top thread: "<!-- thepastaclaw-review v1 finding=a653b94d573e -->" — 1 days old
...
#### Open (4)
- [#3712 test(swift-sdk): first swift sdk integration tests with local network](https://github.com/dashpay/platform/pull/3712) — 30 unresolved (6 CodeRabbit, 24 human) · 1 days stale · 📝 draft
...
- [#3761 chore: update rust-dashcore to latest version](https://github.com/dashpay/platform/pull/3761) — ✋ changes requested
