...
---
# PR Hygiene Report
*Last updated: 2026-06-23 00:48 UTC · commit 102f79e*

## Summary
- Open PRs: **56** (10 clean · 4 CI failing · 3 changes requested · 10 unresolved comments · 10 deferred · 15 draft · 4 stale)
...
| [@ZocoLini](#zocolini) | [7](#zocolini-open) | [3](#zocolini-clean) | — | [2](#zocolini-unresolved-comments) | [1](#zocolini-changes-requested) | — | [1](#zocolini-draft) | — | [4](#zocolini-needs-action) | [15](#zocolini-unresolved-comments) | — | ↑ 2 |
...
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [6+(8)](#lklimek-open) | [1+(0)](#lklimek-clean) | [0+(1)](#lklimek-ci-failing) | — | — | [5+(0)](#lklimek-deferred) | [0+(5)](#lklimek-draft) | [0+(2)](#lklimek-stale) | — | [0+(20)](#lklimek-unresolved-comments) | [1+(0)](#lklimek-ready-for-review) | ↓ 3 |
...
- [#3950 chore(swift-sdk): script to get spv stortage from iOS sim](https://github.com/dashpay/platform/pull/3950) — 2 unresolved (2 human) · 1 days stale
  - Top thread: "<!-- thepastaclaw-review v1 finding=a1f3b18502b6 dedupe=5d600b079d5a3b31 -->" — 1 days old
- [#3946 fix(swift-sdk): keychain privk storage](https://github.com/dashpay/platform/pull/3946) — 1 unresolved (1 human) · 1 days stale
  - Top thread: "<!-- thepastaclaw-review v1 finding=cfdebb05bdb1 dedupe=d68d2b6e0443d4fb -->" — 1 days old
...
- [#3951 fix(sdk): rotate instead of ban on ResourceExhausted rate-limits](https://github.com/dashpay/platform/pull/3951) — via @Claudius-Maginificent · 🔴 CI failing
...
- [#3954 feat(platform-wallet)!: shutdown() joins coordinator threads and returns CoordinatorExitStatus](https://github.com/dashpay/platform/pull/3954) — via @Claudius-Maginificent · 📝 draft
...
#### Open (1)
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 509 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v2.0-dev, untouched 500 days
