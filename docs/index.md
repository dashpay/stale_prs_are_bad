...
---
# PR Hygiene Report
*Last updated: 2026-05-20 12:56 UTC · commit 3be27f2*

## Summary
- Open PRs: **68** (3 clean · 4 CI failing · 6 changes requested · 14 unresolved comments · 9 deferred · 20 draft · 12 stale)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [12+(8)](#lklimek-open) | — | — | [2+(2)](#lklimek-unresolved-comments) | [3+(1)](#lklimek-changes-requested) | [5+(0)](#lklimek-deferred) | [2+(1)](#lklimek-draft) | [0+(4)](#lklimek-stale) | [5+(3)](#lklimek-needs-action) | [2+(31)](#lklimek-unresolved-comments) | — |
...
| [@ZocoLini](#zocolini) | [5](#zocolini-open) | — | — | [2](#zocolini-unresolved-comments) | [1](#zocolini-changes-requested) | — | [2](#zocolini-draft) | — | [3](#zocolini-needs-action) | [8](#zocolini-unresolved-comments) | [1](#zocolini-ready-for-review) |
| [@QuantumExplorer](#quantumexplorer) | [6](#quantumexplorer-open) | [1](#quantumexplorer-clean) | — | [2](#quantumexplorer-unresolved-comments) | — | [2](#quantumexplorer-deferred) | [1](#quantumexplorer-draft) | — | [1](#quantumexplorer-needs-action) | [38](#quantumexplorer-unresolved-comments) | — |
| [@shumkov](#shumkov) | [10](#shumkov-open) | [1](#shumkov-clean) | [1](#shumkov-ci-failing) | [1](#shumkov-unresolved-comments) | — | [1](#shumkov-deferred) | [3](#shumkov-draft) | [3](#shumkov-stale) | [1](#shumkov-needs-action) | [11](#shumkov-unresolved-comments) | — |
...
| [@llbartekll](#llbartekll) | [4](#llbartekll-open) | [1](#llbartekll-clean) | [1](#llbartekll-ci-failing) | — | [1](#llbartekll-changes-requested) | — | [1](#llbartekll-draft) | — | [1](#llbartekll-needs-action) | [1](#llbartekll-unresolved-comments) | — |
...
- [#3639 feat: external signable wallets](https://github.com/dashpay/platform/pull/3639) — 3 unresolved (3 human) · 1 days stale
...
#### Ready for Review (1)
- [#3691 fix(swift-sdk): drop transitive keypath from PersistentTxo unspent prefetch](https://github.com/dashpay/platform/pull/3691) — by @llbartekll
...
- [#3697 fix(drive-abci): correct DECRYPTION branch in SingleContractDocumentType bounds validation](https://github.com/dashpay/platform/pull/3697)
...
- [#3698 chore(release): update changelog and bump version to 3.1.0-dev.2](https://github.com/dashpay/platform/pull/3698)
...
- [#3691 fix(swift-sdk): drop transitive keypath from PersistentTxo unspent prefetch](https://github.com/dashpay/platform/pull/3691)
- [#3694 fix(swift-example): unhide Create Identity submit button and auto-dismiss sheet on success](https://github.com/dashpay/platform/pull/3694) — 🔴 CI failing
