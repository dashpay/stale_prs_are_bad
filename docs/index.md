...
---
# PR Hygiene Report
*Last updated: 2026-08-06 00:29 UTC · commit b282c6e*

## Summary
- Open PRs: **61** (9 clean · 1 CI failing · 4 changes requested · 25 unresolved comments · 11 deferred · 8 draft · 3 stale)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@bfoss765](#bfoss765) | [13](#bfoss765-open) | [3](#bfoss765-clean) | [1](#bfoss765-ci-failing) | [7](#bfoss765-unresolved-comments) | [2](#bfoss765-changes-requested) | — | — | — | [11](#bfoss765-needs-action) | [15](#bfoss765-unresolved-comments) | — | ↑ 1 |
...
| [@shumkov](#shumkov) | [11](#shumkov-open) | [1](#shumkov-clean) | — | [4](#shumkov-unresolved-comments) | [1](#shumkov-changes-requested) | [2](#shumkov-deferred) | [3](#shumkov-draft) | — | [6](#shumkov-needs-action) | [11](#shumkov-unresolved-comments) | [5](#shumkov-ready-for-review) | ↑ 2 |
...
#### Open (13)
- [#4256 feat(platform-wallet): token-minting finalize from a funding path (spendable DashPay receival accounts)](https://github.com/dashpay/platform/pull/4256) — 4 unresolved (4 human) · 5 days stale · ⚠ merge conflict · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=cb9e14c705ab dedupe=72fbc887dcdebc99 -->" — 5 days old
- [#4301 feat(platform-wallet): multi-output shielded transfers + output-aware fee predictor (two-note invites)](https://github.com/dashpay/platform/pull/4301) — 5 unresolved (2 CodeRabbit, 3 human) · 0 days stale · 🔴 CI failing
  - Top thread: "_🎯 Functional Correctness_ \| _🟡 Minor_ \| _⚡ Quick win_" — 0 days old
- [#4247 feat(kotlin-sdk): single-account build_signed_payment send API (funding_path)](https://github.com/dashpay/platform/pull/4247) — 2 unresolved (2 CodeRabbit) · 1 days stale · ⚠ merge conflict · 🔴 CI failing
  - Top thread: "_🩺 Stability & Availability_ \| _🟠 Major_ \| _⚡ Quick win_" — 1 days old
- [#4184 fix: shield asset-lock funding from all funds accounts incl. CoinJoin (#4073)](https://github.com/dashpay/platform/pull/4184) — 1 unresolved (1 human) · 0 days stale · ⚠ merge conflict
  - Top thread: "<!-- thepastaclaw-review v1 finding=4cc5ded6be99 dedupe=ef13b69a80a3d209 -->" — 0 days old
- [#4185 feat(kotlin-sdk): split build/broadcast with reservation release for BIP70-style deferred submission](https://github.com/dashpay/platform/pull/4185) — 1 unresolved (1 human) · 1 days stale · ⚠ merge conflict · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=cf111ea4d67e dedupe=42c20612670e1250 -->" — 1 days old
...
- [#4289 fix(platform-wallet): batch wallet-event persistence + expose sync_fault (watermark-freeze mitigations)](https://github.com/dashpay/platform/pull/4289) — 1 unresolved (1 human) · 1 days stale · 🔴 CI failing
  - Top thread: "<!-- thepastaclaw-review v1 finding=85e495c3eacd dedupe=384c18fa8763150e -->" — 1 days old
...
- [#4196 fix(platform-wallet): age-guard the V2 finalized-transaction handle broadcast (stacked on #4185)](https://github.com/dashpay/platform/pull/4196) — ⚠ merge conflict · 🔴 CI failing
- [#4204 feat(kotlin-sdk): one-time Orchard key shielded-invite API (inviter + claim)](https://github.com/dashpay/platform/pull/4204)
...
- [#4290 fix(platform-wallet): lossless mpsc persistence drain — root-cause fix for the sync-watermark freeze](https://github.com/dashpay/platform/pull/4290) — ⚠ merge conflict · ✋ changes requested
- [#4299 chore(platform-wallet): bump key-wallet pin and migrate to new AddressState/asset-lock API](https://github.com/dashpay/platform/pull/4299) — ⚠ merge conflict · ✋ changes requested
...
- [#4228 ci: release Kotlin and Swift SDKs with the platform release](https://github.com/dashpay/platform/pull/4228) — 2 unresolved (2 CodeRabbit) · 1 days stale
...
- [#4204 feat(kotlin-sdk): one-time Orchard key shielded-invite API (inviter + claim)](https://github.com/dashpay/platform/pull/4204) — by @bfoss765
...
- [#4304 fix(sdk): point parity manifest at the renamed identity-resume test](https://github.com/dashpay/platform/pull/4304) — by @QuantumExplorer
...
- [#4304 fix(sdk): point parity manifest at the renamed identity-resume test](https://github.com/dashpay/platform/pull/4304)
...
#### Open (1)
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 553 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v2.0-dev, untouched 544 days
