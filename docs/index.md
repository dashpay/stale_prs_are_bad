...
---
# PR Hygiene Report
*Last updated: 2026-05-18 21:18 UTC · commit ad379ce*
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@PastaPastaPasta](#pastapastapasta) | [7](#pastapastapasta-open) | [2](#pastapastapasta-clean) | [3](#pastapastapasta-dirty) | — | [2](#pastapastapasta-draft) | [4](#pastapastapasta-needs-action) | [21](#pastapastapasta-dirty) | [1](#pastapastapasta-dirty) | [20](#pastapastapasta-dirty) | — |
| [@Claudius-Maginificent](#claudius-maginificent) | [5](#claudius-maginificent-open) | — | [3](#claudius-maginificent-dirty) | — | [2](#claudius-maginificent-draft) | [3](#claudius-maginificent-needs-action) | [37](#claudius-maginificent-dirty) | [9](#claudius-maginificent-dirty) | [28](#claudius-maginificent-dirty) | — |
| [@QuantumExplorer](#quantumexplorer) | [6](#quantumexplorer-open) | — | [3](#quantumexplorer-dirty) | [2](#quantumexplorer-deferred) | [1](#quantumexplorer-draft) | [2](#quantumexplorer-needs-action) | [44](#quantumexplorer-dirty) | [16](#quantumexplorer-dirty) | [28](#quantumexplorer-dirty) | [11](#quantumexplorer-to-review) |
| [@lklimek](#lklimek) | [13](#lklimek-open) | [4](#lklimek-clean) | [2](#lklimek-dirty) | [5](#lklimek-deferred) | [2](#lklimek-draft) | [4](#lklimek-needs-action) | [8](#lklimek-dirty) | [1](#lklimek-dirty) | [7](#lklimek-dirty) | — |
| [@shumkov](#shumkov) | [9](#shumkov-open) | [4](#shumkov-clean) | [2](#shumkov-dirty) | [1](#shumkov-deferred) | [2](#shumkov-draft) | [3](#shumkov-needs-action) | [14](#shumkov-dirty) | [1](#shumkov-dirty) | [13](#shumkov-dirty) | [2](#shumkov-to-review) |
| [@pshenmic](#pshenmic) | [4](#pshenmic-open) | [1](#pshenmic-clean) | [2](#pshenmic-dirty) | — | [1](#pshenmic-draft) | [2](#pshenmic-needs-action) | [29](#pshenmic-dirty) | [10](#pshenmic-dirty) | [19](#pshenmic-dirty) | — |
| [@ZocoLini](#zocolini) | [5](#zocolini-open) | — | [2](#zocolini-dirty) | — | [3](#zocolini-draft) | [2](#zocolini-needs-action) | [6](#zocolini-dirty) | — | [6](#zocolini-dirty) | — |
| [@thephez](#thephez) | [2](#thephez-open) | — | [2](#thephez-dirty) | — | — | [2](#thephez-needs-action) | [6](#thephez-dirty) | — | [6](#thephez-dirty) | — |
| [@Inna333-cuber](#inna333-cuber) | [1](#inna333-cuber-open) | — | [1](#inna333-cuber-dirty) | — | — | [1](#inna333-cuber-needs-action) | [1](#inna333-cuber-dirty) | — | [1](#inna333-cuber-dirty) | — |
| [@llbartekll](#llbartekll) | [2](#llbartekll-open) | — | [1](#llbartekll-dirty) | — | [1](#llbartekll-draft) | — | [16](#llbartekll-dirty) | [2](#llbartekll-dirty) | [14](#llbartekll-dirty) | — |
| [@thepastaclaw](#thepastaclaw) | [7](#thepastaclaw-open) | — | [1](#thepastaclaw-dirty) | — | [6](#thepastaclaw-draft) | — | [7](#thepastaclaw-dirty) | [2](#thepastaclaw-dirty) | [5](#thepastaclaw-dirty) | — |
...
| [@pauldelucia](#pauldelucia) | [3](#pauldelucia-open) | [1](#pauldelucia-clean) | — | — | [2](#pauldelucia-draft) | — | — | — | — | — |
...
- [#2989 feat(sdk): add credentials-based API for DPNS registerName](https://github.com/dashpay/platform/pull/2989) — ✋ changes requested · 🔴 CI failing
...
#### Open (5)
- [#3549 test(rs-platform-wallet): e2e suite, Found-025 fix + triage pins](https://github.com/dashpay/platform/pull/3549) — 22 unresolved (22 human) · 16 days stale · 🔴 CI failing · 📝 draft
  - Top thread: "<!-- thepastaclaw-review v1 finding=a3725e9d50ca -->" — 16 days old
- [#3625 feat(platform-wallet): add platform-wallet-storage crate (sqlite persister)](https://github.com/dashpay/platform/pull/3625) — 8 unresolved (8 CodeRabbit) · 7 days stale · ⚠ merge conflict · 📝 draft
...
<a id="claudius-maginificent-dirty"></a>
#### Dirty (3)
- [#3637 feat(platform-wallet): serde support](https://github.com/dashpay/platform/pull/3637) — 5 unresolved (1 CodeRabbit, 4 human) · 5 days stale · ⚠ merge conflict
  - Top thread: "_⚠️ Potential issue_ \| _🔴 Critical_" — 5 days old
- [#3585 fix: case-insensitive .dash + atomic state on broadcast failure](https://github.com/dashpay/platform/pull/3585) — 1 unresolved (1 human) · 6 days stale · ✋ changes requested
...
- [#3661 feat(drive): document sum + average proof primitives, with SDK fan-out scaffolding and reproducible benchmarks](https://github.com/dashpay/platform/pull/3661) — 5 unresolved (5 CodeRabbit) · 0 days stale · 🔴 CI failing
...
#### To review (11)
- [#2031 build: drive binary build script](https://github.com/dashpay/platform/pull/2031) — by @shumkov
- [#2392 feat(dashmate): single node local network [WIP\]](https://github.com/dashpay/platform/pull/2392) — by @shumkov · 🔴 CI failing
- [#2727 fix(drive): fix verification data contract verification logic with keeps history](https://github.com/dashpay/platform/pull/2727) — by @pshenmic · 🔴 CI failing
- [#2988 feat(wasm-sdk): auto-generate entropy for document creation when not provided](https://github.com/dashpay/platform/pull/2988) — by @PastaPastaPasta · 🔴 CI failing
- [#2989 feat(sdk): add credentials-based API for DPNS registerName](https://github.com/dashpay/platform/pull/2989) — by @PastaPastaPasta · ✋ changes requested · 🔴 CI failing
- [#2996 fix(drive-abci): version fix for decryption bounded key validation in contract bounds](https://github.com/dashpay/platform/pull/2996) — by @pauldelucia · 🔴 CI failing
- [#3162 fix(dashmate): prevent orphaned verification container blocking SSL renewal](https://github.com/dashpay/platform/pull/3162) — by @ktechmidas · 🔴 CI failing
...
- [#2031 build: drive binary build script](https://github.com/dashpay/platform/pull/2031)
- [#2392 feat(dashmate): single node local network [WIP\]](https://github.com/dashpay/platform/pull/2392) — 🔴 CI failing
- [#2518 feat: token marketplace](https://github.com/dashpay/platform/pull/2518) — 📝 draft · ⏸ deferred
- [#2552 perf(dapi): fetch only specific unconfirmed transaction](https://github.com/dashpay/platform/pull/2552) — ⚠ merge conflict · 🔴 CI failing
- [#2973 [temp\] Test non determinism](https://github.com/dashpay/platform/pull/2973) — ⚠ merge conflict · 🔴 CI failing · 📝 draft
...
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 474 days stale · ⚠ merge conflict · 📝 draft
  - Top thread: "_:warning: Potential issue_" — 474 days old
- [#2727 fix(drive): fix verification data contract verification logic with keeps history](https://github.com/dashpay/platform/pull/2727) — 🔴 CI failing
...
<a id="pshenmic-draft"></a>
#### Draft (1)
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 474 days stale · ⚠ merge conflict · 📝 draft
  - Top thread: "_:warning: Potential issue_" — 474 days old

<a id="pshenmic-clean"></a>
#### Clean (1)
- [#2727 fix(drive): fix verification data contract verification logic with keeps history](https://github.com/dashpay/platform/pull/2727) — 🔴 CI failing
...
- [#3664 chore(swift-sdk): remove key-wallet-ffi crate usage, platform-wallet-ffi wraps all the logic](https://github.com/dashpay/platform/pull/3664) — 📝 draft
...
#### Open (7)
- [#3096 feat(sdk): add client-side validation to state transition construction methods](https://github.com/dashpay/platform/pull/3096) — 4 unresolved (2 CodeRabbit, 2 human) · 89 days stale · 📝 draft
  - Top thread: "_⚠️ Potential issue_ \| _🟡 Minor_" — 87 days old
- [#3165 fix(drive): consolidate historical contract proof verification retry logic](https://github.com/dashpay/platform/pull/3165) — 3 unresolved (3 human) · 73 days stale
  - Top thread: "PROJ-003** (INFO) — No coverage for `in_multiple_contract_proof_form=true`" — 73 days old
- [#3091 feat(wasm-sdk): add prepare_* APIs for idempotent document state transitions](https://github.com/dashpay/platform/pull/3091) — ✋ changes requested · 📝 draft
- [#3092 feat(rs-sdk): expose transition hash from state transition methods](https://github.com/dashpay/platform/pull/3092) — ✋ changes requested · 🔴 CI failing · 📝 draft
- [#3133 fix(sdk): validate batch base structure before signing](https://github.com/dashpay/platform/pull/3133) — ✋ changes requested · 📝 draft
- [#3596 fix(platform-wallet): satisfy accessors clippy lints](https://github.com/dashpay/platform/pull/3596) — 📝 draft
- [#3635 ci: tolerate book preview comment permission errors](https://github.com/dashpay/platform/pull/3635) — 📝 draft

<a id="thepastaclaw-dirty"></a>
#### Dirty (1)
- [#3165 fix(drive): consolidate historical contract proof verification retry logic](https://github.com/dashpay/platform/pull/3165) — 3 unresolved (3 human) · 73 days stale
  - Top thread: "PROJ-003** (INFO) — No coverage for `in_multiple_contract_proof_form=true`" — 73 days old
...
#### Open (1)
- [#3162 fix(dashmate): prevent orphaned verification container blocking SSL renewal](https://github.com/dashpay/platform/pull/3162) — 🔴 CI failing
...
#### Open (3)
- [#2974 feat(drive): add array element indexing support](https://github.com/dashpay/platform/pull/2974) — 🔴 CI failing · 📝 draft
- [#2977 feat(dapi): return actual fees paid in state transition broadcast responses](https://github.com/dashpay/platform/pull/2977) — 🔴 CI failing · 📝 draft
- [#2996 fix(drive-abci): version fix for decryption bounded key validation in contract bounds](https://github.com/dashpay/platform/pull/2996) — 🔴 CI failing

<a id="pauldelucia-draft"></a>
#### Draft (2)
- [#2974 feat(drive): add array element indexing support](https://github.com/dashpay/platform/pull/2974) — 🔴 CI failing · 📝 draft
- [#2977 feat(dapi): return actual fees paid in state transition broadcast responses](https://github.com/dashpay/platform/pull/2977) — 🔴 CI failing · 📝 draft

<a id="pauldelucia-clean"></a>
#### Clean (1)
- [#2996 fix(drive-abci): version fix for decryption bounded key validation in contract bounds](https://github.com/dashpay/platform/pull/2996) — 🔴 CI failing
