...
---
# PR Hygiene Report
*Last updated: 2026-05-25 13:12 UTC · commit 6c1fac8*

## Summary
- Open PRs: **62** (5 clean · 0 CI failing · 11 changes requested · 7 unresolved comments · 9 deferred · 17 draft · 13 stale)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [8+(11)](#pastapastapasta-open) | [1+(0)](#pastapastapasta-clean) | — | [3+(0)](#pastapastapasta-unresolved-comments) | [0+(1)](#pastapastapasta-changes-requested) | — | [4+(8)](#pastapastapasta-draft) | [0+(2)](#pastapastapasta-stale) | [3+(1)](#pastapastapasta-needs-action) | [3+(4)](#pastapastapasta-unresolved-comments) | — | ↓ 1 |
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [11+(9)](#lklimek-open) | [3+(0)](#lklimek-clean) | — | [1+(1)](#lklimek-unresolved-comments) | [1+(3)](#lklimek-changes-requested) | [5+(0)](#lklimek-deferred) | [0+(1)](#lklimek-draft) | [1+(4)](#lklimek-stale) | [2+(4)](#lklimek-needs-action) | [1+(25)](#lklimek-unresolved-comments) | — | ↓ 2 |
| [@QuantumExplorer](#quantumexplorer) | [5](#quantumexplorer-open) | [1](#quantumexplorer-clean) | — | [1](#quantumexplorer-unresolved-comments) | — | [2](#quantumexplorer-deferred) | [1](#quantumexplorer-draft) | — | [1](#quantumexplorer-needs-action) | [11](#quantumexplorer-unresolved-comments) | [3](#quantumexplorer-ready-for-review) | ↓ 1 |
...
| [@llbartekll](#llbartekll) | [3](#llbartekll-open) | — | — | — | [2](#llbartekll-changes-requested) | — | [1](#llbartekll-draft) | — | [2](#llbartekll-needs-action) | [1](#llbartekll-unresolved-comments) | [2](#llbartekll-ready-for-review) | ↑ 2 |
| [@shumkov](#shumkov) | [6](#shumkov-open) | — | — | — | [2](#shumkov-changes-requested) | [1](#shumkov-deferred) | [1](#shumkov-draft) | [2](#shumkov-stale) | [2](#shumkov-needs-action) | — | [1](#shumkov-ready-for-review) | ↓ 1 |
...
#### Open (19)
- [#3096 feat(sdk): add client-side validation to state transition construction methods](https://github.com/dashpay/platform/pull/3096) — via @thepastaclaw · 4 unresolved (2 CodeRabbit, 2 human) · 96 days stale · 📝 draft
  - Top thread: "_⚠️ Potential issue_ \| _🟡 Minor_" — 93 days old
...
- [#3734 feat(rs-sdk-ffi): expose SDK protocol version pinning](https://github.com/dashpay/platform/pull/3734) — via @thepastaclaw · 📝 draft
...
- [#3637 feat(platform-wallet): serde support](https://github.com/dashpay/platform/pull/3637) — via @Claudius-Maginificent · 5 unresolved (1 CodeRabbit, 4 human) · 12 days stale · ⚠ merge conflict
  - Top thread: "_⚠️ Potential issue_ \| _🔴 Critical_" — 11 days old
- [#3721 test(rs-sdk): relocate DPNS network tests from src/ to tests/](https://github.com/dashpay/platform/pull/3721) — 1 unresolved (1 CodeRabbit) · 3 days stale
...
- [#3625 feat(platform-wallet): add platform-wallet-storage crate (sqlite persister)](https://github.com/dashpay/platform/pull/3625) — via @Claudius-Maginificent · ✋ changes requested
...
- [#3658 fix(platform-wallet): reserve platform receive address on hand-out (Found-026) [backport\]](https://github.com/dashpay/platform/pull/3658)
...
- [#3735 fix(platform-wallet-ffi): wallet_id gate on resolver-fed sign entrypoints](https://github.com/dashpay/platform/pull/3735) — via @Claudius-Maginificent · 🔴 CI failing · 📝 draft
...
#### Open (5)
- [#3557 feat(platform-wallet): instrument wallet_manager RwLock behind lock-stats feature](https://github.com/dashpay/platform/pull/3557) — 11 unresolved (2 CodeRabbit, 9 human) · 27 days stale
...
- [#3658 fix(platform-wallet): reserve platform receive address on hand-out (Found-026) [backport\]](https://github.com/dashpay/platform/pull/3658) — by @lklimek
...
#### Open (1)
- [#3162 fix(dashmate): prevent orphaned verification container blocking SSL renewal](https://github.com/dashpay/platform/pull/3162) — 6 unresolved (6 human) · 6 days stale
  - Top thread: "<!-- thepastaclaw-review v1 finding=d7ee272d2ab4 dedupe=d8f79f6f47c868dc -->" — 6 days old
...
#### Open (3)
- [#3481 feat(swift-sdk): expose rich transaction fields in WalletTransaction](https://github.com/dashpay/platform/pull/3481) — 1 unresolved (1 CodeRabbit) · 42 days stale · ⚠ merge conflict · 🔴 CI failing · 📝 draft
...
#### Open (4)
- [#2444 feat(sdk): add NFT actions in the JS Dash SDK](https://github.com/dashpay/platform/pull/2444) — 17 unresolved (5 CodeRabbit, 12 human) · 452 days stale · ⚠ merge conflict · ✋ changes requested · 🐢 targets v2.0-dev
  - Top thread: "_:warning: Potential issue_" — 452 days old
- [#2465 fix(sdk): replace seeds with ip address](https://github.com/dashpay/platform/pull/2465) — 7 unresolved (7 human) · 462 days stale · ✋ changes requested · 🐢 targets master
  - Top thread: "Why do we use testnet seeds for mainnet?" — 462 days old
- [#2446 feat(js-dapi-client): add contested resources query methods](https://github.com/dashpay/platform/pull/2446) — 5 unresolved (5 CodeRabbit) · 481 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v2.0-dev, untouched 471 days
