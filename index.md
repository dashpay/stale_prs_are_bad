...
---
# PR Hygiene Report
*Last updated: 2026-09-21 18:14 UTC · commit dab9533*

## Summary
- Open PRs: **102** (21 clean · 2 CI failing · 1 changes requested · 21 unresolved comments · 0 deferred · 18 draft · 39 stale)
...
- dashpay/tenderdash: **6** open (5 clean · 0 CI failing · 0 changes requested · 0 unresolved comments · 0 deferred · 1 draft · 0 stale) · engine: 1 draft · 3 waiting-bots · 2 waiting-self-review
...
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [14+(6)](#lklimek-open) | [5+(2)](#lklimek-clean) | — | [5+(2)](#lklimek-unresolved-comments) | — | — | [2+(0)](#lklimek-draft) | [2+(2)](#lklimek-stale) | [5+(4)](#lklimek-needs-action) | — | [22+(16)](#lklimek-unresolved-comments) | [4+(0)](#lklimek-ready-for-review) | ↓ 1 |
| [@QuantumExplorer](#quantumexplorer) | [12](#quantumexplorer-open) | [2](#quantumexplorer-clean) | — | [2](#quantumexplorer-unresolved-comments) | — | — | [1](#quantumexplorer-draft) | [7](#quantumexplorer-stale) | [2](#quantumexplorer-needs-action) | — | [18](#quantumexplorer-unresolved-comments) | [7](#quantumexplorer-ready-for-review) | — |
...
| [@shumkov](#shumkov) | [9](#shumkov-open) | — | — | [1](#shumkov-unresolved-comments) | — | — | — | [8](#shumkov-stale) | [1](#shumkov-needs-action) | — | [30](#shumkov-unresolved-comments) | [8](#shumkov-ready-for-review) | ↓ 6 |
...
- [dashpay/platform#4632 feat(sdk)!: pure DPNS and DashPay document builders shared with embedders](https://github.com/dashpay/platform/pull/4632) — 2 unresolved (2 bot) · 10 days stale · ⚠ merge conflict · ✋ changes requested · areas: rust-sdk, fallback · Policy: waiting-bots
  ...
  - Blocker: thepastaclaw left review threads unresolved; resolve them
- [dashpay/platform#4842 feat(platform)!: add the app-connect system contract (protocol 14)](https://github.com/dashpay/platform/pull/4842) — 4 unresolved (1 CodeRabbit, 3 bot) · 2 days stale · ⚠ merge conflict · 🔴 CI failing · areas: rs-drive, rs-drive-abci, dpp, rust-sdk, rust-sdk-ffi, js-wasm-sdk, system-contracts, fallback · Policy: waiting-bots
  - Top thread: "🟡 Suggestion: Honor AppConnect activation in the client contract provider**" — 2 days old
  - Blocker: thepastaclaw requested changes on this head; dismiss the review or push a fix
  - Blocker: coderabbitai left review threads unresolved; resolve them
  - Blocker: thepastaclaw left review threads unresolved; resolve them
...
- [dashpay/dash-evo-tool#980 feat(identity): add wallet-derived keys to existing identities](https://github.com/dashpay/dash-evo-tool/pull/980) — 2 unresolved (2 CodeRabbit) · 0 days stale · ⚠ merge conflict · areas: dash-evo-tool · Policy: waiting-bots
  ...
  - Blocker: coderabbitai left review threads unresolved; resolve them
- [dashpay/dash-evo-tool#976 fix(security): protect identity keys before import storage](https://github.com/dashpay/dash-evo-tool/pull/976) — 1 unresolved (1 CodeRabbit) · 3 days stale · ⚠ merge conflict · areas: dash-evo-tool · Policy: waiting-bots
  - Top thread: "_🗄️ Data Integrity & Integration_ \| _🟡 Minor_ \| _⚡ Quick win_" — 3 days old
  - Blocker: coderabbitai left review threads unresolved; resolve them
...
- [dashpay/tenderdash#1490 fix(p2p): reconnect persistent peers at outgoing capacity](https://github.com/dashpay/tenderdash/pull/1490) — areas: tenderdash · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/tenderdash#1492 fix(statesync): bound retained snapshot discovery resources](https://github.com/dashpay/tenderdash/pull/1492) — areas: tenderdash · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/tenderdash#1493 test(e2e): check large transaction batches without assuming order](https://github.com/dashpay/tenderdash/pull/1493) — areas: tenderdash · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#4799 fix(sdk): fetch and persist managed identity credit balances](https://github.com/dashpay/platform/pull/4799) — by @llbartekll · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, rust-sdk, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#4887 feat(platform)!: a document batch proof carries the owner's credit balance](https://github.com/dashpay/platform/pull/4887) — by @QuantumExplorer · areas: rs-drive, rs-drive-abci, dpp, rust-sdk, js-wasm-sdk, rust-dapi, fallback · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#4886 feat(platform)!: elected moderation team declaration with frozen election parameters and interim mode](https://github.com/dashpay/platform/pull/4886) — areas: rs-drive-abci, dpp, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#4887 feat(platform)!: a document batch proof carries the owner's credit balance](https://github.com/dashpay/platform/pull/4887) — areas: rs-drive, rs-drive-abci, dpp, rust-sdk, js-wasm-sdk, rust-dapi, fallback · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#4799 fix(sdk): fetch and persist managed identity credit balances](https://github.com/dashpay/platform/pull/4799) — by @llbartekll · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, rust-sdk, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#4886 feat(platform)!: elected moderation team declaration with frozen election parameters and interim mode](https://github.com/dashpay/platform/pull/4886) — by @QuantumExplorer · areas: rs-drive-abci, dpp, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#4887 feat(platform)!: a document batch proof carries the owner's credit balance](https://github.com/dashpay/platform/pull/4887) — by @QuantumExplorer · areas: rs-drive, rs-drive-abci, dpp, rust-sdk, js-wasm-sdk, rust-dapi, fallback · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/tenderdash#1489 fix(statesync): unblock chunk delivery during sync teardown](https://github.com/dashpay/tenderdash/pull/1489) — by @lklimek · areas: tenderdash · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed 630a8a29a6b157b4b90b67ffc5081c5f595ee041 after bot completion
- [dashpay/tenderdash#1490 fix(p2p): reconnect persistent peers at outgoing capacity](https://github.com/dashpay/tenderdash/pull/1490) — by @lklimek · areas: tenderdash · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/tenderdash#1491 fix(statesync): correlate consensus parameter replies with pending requests](https://github.com/dashpay/tenderdash/pull/1491) — by @lklimek · areas: tenderdash · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed 3279ffe9c396ac06119a536c5c07f55365af13a7 after bot completion
- [dashpay/tenderdash#1492 fix(statesync): bound retained snapshot discovery resources](https://github.com/dashpay/tenderdash/pull/1492) — by @lklimek · areas: tenderdash · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/tenderdash#1493 test(e2e): check large transaction batches without assuming order](https://github.com/dashpay/tenderdash/pull/1493) — by @lklimek · areas: tenderdash · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
