...
---
# PR Hygiene Report
*Last updated: 2026-09-23 18:20 UTC · commit 5b60ca8*

## Summary
- Open PRs: **95** (15 clean · 3 CI failing · 1 changes requested · 18 unresolved comments · 0 deferred · 16 draft · 42 stale)
- PRs needing author action: **23**
- Total unresolved comments: **146**
- dashpay/platform: **48** open (0 clean · 1 CI failing · 0 changes requested · 9 unresolved comments · 0 deferred · 3 draft · 35 stale) · engine: 14 draft · 2 ready-to-merge · 22 waiting-author · 1 waiting-bots · 3 waiting-self-review · 6 no verdict
- dashpay/rust-dashcore: **30** open (5 clean · 2 CI failing · 1 changes requested · 4 unresolved comments · 0 deferred · 13 draft · 5 stale) · engine: 16 draft · 3 waiting-author · 9 waiting-self-review · 2 no verdict
...
- dashpay/grovedb: **4** open (3 clean · 0 CI failing · 0 changes requested · 1 unresolved comments · 0 deferred · 0 draft · 0 stale) · engine: 1 waiting-author · 3 waiting-bots
- dashpay/dash-evo-tool: **12** open (6 clean · 0 CI failing · 0 changes requested · 4 unresolved comments · 0 deferred · 0 draft · 2 stale) · engine: 1 ready-for-human · 1 ready-to-merge · 2 waiting-author · 6 waiting-bots · 2 no verdict
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [21+(8)](#pastapastapasta-open) | [0+(3)](#pastapastapasta-clean) | [2+(1)](#pastapastapasta-ci-failing) | [7+(0)](#pastapastapasta-unresolved-comments) | — | — | [2+(2)](#pastapastapasta-draft) | [10+(2)](#pastapastapasta-stale) | [7+(2)](#pastapastapasta-needs-action) | — | [39+(6)](#pastapastapasta-unresolved-comments) | — | ↓ 3 |
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [8+(7)](#lklimek-open) | [3+(2)](#lklimek-clean) | — | [3+(1)](#lklimek-unresolved-comments) | — | — | — | [2+(4)](#lklimek-stale) | [4+(2)](#lklimek-needs-action) | [0+(2)](#lklimek-ready-for-human) | [24+(11)](#lklimek-unresolved-comments) | [2+(0)](#lklimek-ready-for-review) | ↓ 5 |
| [@QuantumExplorer](#quantumexplorer) | [15](#quantumexplorer-open) | [3](#quantumexplorer-clean) | — | [3](#quantumexplorer-unresolved-comments) | — | — | [2](#quantumexplorer-draft) | [7](#quantumexplorer-stale) | [3](#quantumexplorer-needs-action) | — | [21](#quantumexplorer-unresolved-comments) | [4](#quantumexplorer-ready-for-review) | — |
...
| [@shumkov](#shumkov) | [9](#shumkov-open) | — | — | [1](#shumkov-unresolved-comments) | — | — | — | [8](#shumkov-stale) | [1](#shumkov-needs-action) | — | [34](#shumkov-unresolved-comments) | [1](#shumkov-ready-for-review) | ↓ 1 |
...
| [@ZocoLini](#zocolini) | [7](#zocolini-open) | [2](#zocolini-clean) | — | — | — | — | [5](#zocolini-draft) | — | — | — | [2](#zocolini-unresolved-comments) | [1](#zocolini-ready-for-review) | ↓ 3 |
| [@bfoss765](#bfoss765) | [2](#bfoss765-open) | — | — | — | — | — | — | [2](#bfoss765-stale) | — | — | [3](#bfoss765-unresolved-comments) | — | ↓ 1 |
| [@infraclaw-dash](#infraclaw-dash) | [3](#infraclaw-dash-open) | — | — | — | — | — | — | [3](#infraclaw-dash-stale) | — | [2](#infraclaw-dash-ready-for-human) | [2](#infraclaw-dash-unresolved-comments) | — | ↓ 1 |
...
- [dashpay/rust-dashcore#901 fix(key-wallet): discover Coinbase/AssetUnlock outputs for all fund-bearing accounts](https://github.com/dashpay/rust-dashcore/pull/901) — via @thepastaclaw · 2 unresolved (2 CodeRabbit) · 48 days stale · ⚠ merge conflict · ✋ changes requested · 📝 draft · areas: dash-spv, key-wallet · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/platform#4844 feat(sdk)!: key limits, DIP-14 sub-feature derivation and decode-any-kind for DashPay Connect](https://github.com/dashpay/platform/pull/4844) — 5 unresolved (4 CodeRabbit, 1 bot) · 4 days stale · 🔴 CI failing · areas: rs-drive-abci, dpp, rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, rust-sdk, rust-sdk-ffi, js-wasm-sdk, kotlin-sdk, fallback · Policy: waiting-author
...
- [dashpay/platform#4932 chore(platform)!: bump rust-dashcore to 719de34b (secp256k1 0.33)](https://github.com/dashpay/platform/pull/4932) — 🔴 CI failing · areas: rs-drive-abci, dpp, rs-platform-wallet, rs-platform-wallet-ffi, rust-sdk, rust-sdk-ffi, js-wasm-sdk, fallback · Policy: waiting-author
  - Blocker: thepastaclaw left review threads unresolved; resolve them
...
- [dashpay/platform#3549 test(platform-wallet): e2e framework + full test suite — triage pins, Found-*/PA-* guards, fail-closed persist, Stage-2 merge](https://github.com/dashpay/platform/pull/3549) — via @Claudius-Maginificent · 9 unresolved (9 bot) · 144 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v4.3-dev · areas: rs-drive, rs-drive-abci, rs-platform-wallet, rs-platform-wallet-ffi, rust-sdk, fallback · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/dash-evo-tool#901 feat(dpns): unify safe masternode voting operations](https://github.com/dashpay/dash-evo-tool/pull/901) — 12 unresolved (12 bot) · 5 days stale · ⚠ merge conflict · areas: dash-evo-tool · Policy: waiting-bots
...
- [dashpay/platform#4777 fix(platform-wallet)!: preserve Core wallet snapshots on restart](https://github.com/dashpay/platform/pull/4777) — 7 unresolved (7 bot) · 4 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v4.3-dev · areas: rs-platform-wallet, wallet-storage, fallback · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/dash-evo-tool#1021 refactor(wallet): centralize registry and live metadata ownership](https://github.com/dashpay/dash-evo-tool/pull/1021) — 3 unresolved (3 CodeRabbit) · 0 days stale · areas: dash-evo-tool · Policy: waiting-bots
...
- [dashpay/platform#4740 fix(platform-wallet): rescan DashPay contact accounts from the contact request height](https://github.com/dashpay/platform/pull/4740) — 1 unresolved (1 bot) · 0 days stale · 🐢 targets v4.3-dev · areas: rs-platform-wallet, fallback · Policy: waiting-bots
  - Top thread: "🟡 Suggestion: Distinguish pagination exhaustion before marking the sent sweep complete**" — 0 days old
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw left review threads unresolved; resolve them
...
- [dashpay/grovedb#977 fix(storage-flags): accept only canonical multi-epoch flag bytes](https://github.com/dashpay/grovedb/pull/977) — 1 unresolved (1 bot) · 7 days stale · areas: grovedb · Policy: waiting-author
  - Top thread: "🟡 Suggestion: Mark the new exhaustive error variant as a breaking public API change**" — 7 days old
  - Blocker: thepastaclaw left review threads unresolved; resolve them
  - Blocker: Proceeded without coderabbitai: no review within the configured window
- [dashpay/grovedb#988 fix(merk,grovedb): refuse backward-reference rows in count-offset proofs](https://github.com/dashpay/grovedb/pull/988) — areas: grovedb · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/grovedb#989 fix(replication): refuse a peer-chosen tree type of another family when serving chunks](https://github.com/dashpay/grovedb/pull/989) — areas: grovedb · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/grovedb#990 fix(proof): bound bulk-append extraction before the root is bound](https://github.com/dashpay/grovedb/pull/990) — areas: grovedb · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/rust-dashcore#1041 chore(key-wallet): drop the unused vendored PSBT implementation](https://github.com/dashpay/rust-dashcore/pull/1041) — by @ZocoLini · areas: key-wallet, fallback · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed 1fba9b1bd9be46df17e5c37e70910bc9a95df85b after bot completion
  - Blocker: Proceeded without coderabbitai: no review within the configured window
...
- [dashpay/rust-dashcore#993 fix(dash-spv): wire up masternode persistence and shrink it 67x](https://github.com/dashpay/rust-dashcore/pull/993) — areas: dash-spv, fallback · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed 2a03f8f35923cbf90aba677047e1891e924d4953 after bot completion
- [dashpay/rust-dashcore#1016 refactor(dash-spv): drop committed range sweep](https://github.com/dashpay/rust-dashcore/pull/1016) — 📝 draft · areas: dash-spv · Policy: draft
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/rust-dashcore#1024 perf(dash-spv): reduce ram usage](https://github.com/dashpay/rust-dashcore/pull/1024) — 🔴 CI failing · 📝 draft · areas: dash-spv, fallback · Policy: draft
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/rust-dashcore#1041 chore(key-wallet): drop the unused vendored PSBT implementation](https://github.com/dashpay/rust-dashcore/pull/1041) — areas: key-wallet, fallback · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed 1fba9b1bd9be46df17e5c37e70910bc9a95df85b after bot completion
  - Blocker: Proceeded without coderabbitai: no review within the configured window
