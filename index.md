...
---
# PR Hygiene Report
*Last updated: 2026-09-17 00:27 UTC · commit 6d57d4c*

## Summary
- Open PRs: **98** (16 clean · 2 CI failing · 2 changes requested · 19 unresolved comments · 0 deferred · 20 draft · 39 stale)
- PRs needing author action: **26**
- Total unresolved comments: **161**
- dashpay/platform: **47** open (2 clean · 0 CI failing · 0 changes requested · 6 unresolved comments · 0 deferred · 3 draft · 36 stale) · engine: 7 configuration-error · 3 draft · 1 waiting-bots · 36 no verdict
- dashpay/rust-dashcore: **32** open (6 clean · 2 CI failing · 2 changes requested · 6 unresolved comments · 0 deferred · 14 draft · 2 stale) · engine: 14 configuration-error · 14 draft · 2 waiting-self-review · 2 no verdict
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [12+(6)](#lklimek-open) | [3+(0)](#lklimek-clean) | — | [3+(5)](#lklimek-unresolved-comments) | — | — | [3+(0)](#lklimek-draft) | [3+(1)](#lklimek-stale) | [3+(5)](#lklimek-needs-action) | — | [13+(19)](#lklimek-unresolved-comments) | [4+(0)](#lklimek-ready-for-review) | ↑ 3 |
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [20+(11)](#pastapastapasta-open) | [0+(6)](#pastapastapasta-clean) | [1+(1)](#pastapastapasta-ci-failing) | [4+(0)](#pastapastapasta-unresolved-comments) | — | — | [3+(2)](#pastapastapasta-draft) | [12+(2)](#pastapastapasta-stale) | [5+(4)](#pastapastapasta-needs-action) | — | [37+(6)](#pastapastapasta-unresolved-comments) | — | ↓ 6 |
| [@shumkov](#shumkov) | [10](#shumkov-open) | — | — | [2](#shumkov-unresolved-comments) | — | — | — | [8](#shumkov-stale) | [2](#shumkov-needs-action) | — | [54](#shumkov-unresolved-comments) | [2](#shumkov-ready-for-review) | ↓ 1 |
| [@ZocoLini](#zocolini) | [8](#zocolini-open) | [3](#zocolini-clean) | — | [1](#zocolini-unresolved-comments) | [1](#zocolini-changes-requested) | — | [3](#zocolini-draft) | — | [2](#zocolini-needs-action) | — | [2](#zocolini-unresolved-comments) | [2](#zocolini-ready-for-review) | ↑ 2 |
...
| [@QuantumExplorer](#quantumexplorer) | [11](#quantumexplorer-open) | [1](#quantumexplorer-clean) | — | [1](#quantumexplorer-unresolved-comments) | — | — | [1](#quantumexplorer-draft) | [8](#quantumexplorer-stale) | [1](#quantumexplorer-needs-action) | — | [20](#quantumexplorer-unresolved-comments) | [5](#quantumexplorer-ready-for-review) | ↓ 4 |
...
- [dashpay/platform#4764 fix(platform-wallet): select available signing keys across identity operations](https://github.com/dashpay/platform/pull/4764) — 5 unresolved (5 bot) · 0 days stale · ⚠ merge conflict · ✋ changes requested · 🐢 targets v4.3-dev · areas: rs-drive, rs-drive-abci, rs-platform-wallet, rust-sdk, dashmate, js-wasm-sdk, system-contracts, fallback
  - Top thread: "🔴 Blocking: Masternode-list v0 behavior was changed without a versioned generation**" — 0 days old
...
- [dashpay/dash-evo-tool#983 test(migration): add cross-version migration test matrix](https://github.com/dashpay/dash-evo-tool/pull/983) — via @Claudius-Maginificent · 1 unresolved (1 CodeRabbit) · 6 days stale · ✋ changes requested · areas: dash-evo-tool · Policy: configuration-error
  ...
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#976 fix(security): protect identity keys before import storage](https://github.com/dashpay/dash-evo-tool/pull/976) — 1 unresolved (1 bot) · 0 days stale · ✋ changes requested · areas: dash-evo-tool · Policy: configuration-error
  - Top thread: "🔴 Blocking: Record merged key placements before sealing them**" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4740 fix(platform-wallet): scan DashPay contact accounts from request height](https://github.com/dashpay/platform/pull/4740) — 1 unresolved (1 bot) · 1 days stale · areas: rs-platform-wallet, swift-sdk · Policy: configuration-error
  ...
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/rust-dashcore#1028 fix(key-wallet)!: restore persisted wallet state atomically](https://github.com/dashpay/rust-dashcore/pull/1028) — via @Claudius-Maginificent · 1 unresolved (1 CodeRabbit) · 0 days stale · ✋ changes requested · areas: key-wallet · ⚠ ownership unresolved: key-wallet · Policy: configuration-error
...
- [dashpay/dash-evo-tool#859 perf: detect system theme off UI thread](https://github.com/dashpay/dash-evo-tool/pull/859) — by @thepastaclaw · areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4738 fix(platform-wallet): look up the funding tx's block when a ChainLock proof has no record height](https://github.com/dashpay/platform/pull/4738) — by @romchornyi · areas: rs-platform-wallet, rust-sdk, fallback · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
...
- [dashpay/platform#4738 fix(platform-wallet): look up the funding tx's block when a ChainLock proof has no record height](https://github.com/dashpay/platform/pull/4738) — by @romchornyi · areas: rs-platform-wallet, rust-sdk, fallback · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4791 feat(platform)!: add contract groups](https://github.com/dashpay/platform/pull/4791) — by @QuantumExplorer · areas: rs-drive, rs-drive-abci, dpp, fallback · Policy: waiting-bots
...
- [dashpay/platform#4776 feat(platform-wallet)!: let contract updates clear the description through the FFI](https://github.com/dashpay/platform/pull/4776) — 1 unresolved (1 bot) · 0 days stale · 🐢 targets feat/delta-contract-update-pv15 · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, kotlin-sdk, fallback
  - Top thread: "🟡 Suggestion: Reject whitespace descriptions when clearDescription is set**" — 0 days old
...
- [dashpay/platform#4791 feat(platform)!: add contract groups](https://github.com/dashpay/platform/pull/4791) — areas: rs-drive, rs-drive-abci, dpp, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#4595 fix(swift-sdk): make a changeset round linear without giving up atomicity](https://github.com/dashpay/platform/pull/4595) — 2 unresolved (2 bot) · 9 days stale · ⚠ merge conflict · ✋ changes requested · areas: swift-sdk · Policy: configuration-error
  ...
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4738 fix(platform-wallet): look up the funding tx's block when a ChainLock proof has no record height](https://github.com/dashpay/platform/pull/4738) — areas: rs-platform-wallet, rust-sdk, fallback · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
...
#### Open (2)
- [dashpay/platform#4313 feat(kotlin-sdk): one-time Orchard key shielded-invite API (inviter + claim)](https://github.com/dashpay/platform/pull/4313) — 2 unresolved (2 bot) · 16 days stale · ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · 🐢 targets v4.3-dev · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, kotlin-sdk, fallback
