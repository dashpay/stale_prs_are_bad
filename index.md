...
---
# PR Hygiene Report
*Last updated: 2026-09-26 00:29 UTC · commit 1272b04*

## Summary
- Open PRs: **116** (7 clean · 5 CI failing · 1 changes requested · 22 unresolved comments · 0 deferred · 22 draft · 59 stale)
- PRs needing author action: **26**
- Total unresolved comments: **164**
- dashpay/platform: **74** open (4 clean · 2 CI failing · 0 changes requested · 10 unresolved comments · 0 deferred · 5 draft · 53 stale) · engine: 17 draft · 9 ready-for-human · 2 ready-to-merge · 25 waiting-author · 6 waiting-bots · 6 waiting-build · 6 waiting-self-review · 3 no verdict
- dashpay/rust-dashcore: **29** open (2 clean · 3 CI failing · 1 changes requested · 4 unresolved comments · 0 deferred · 14 draft · 5 stale) · engine: 17 draft · 3 waiting-author · 7 waiting-self-review · 2 no verdict
...
| [@QuantumExplorer](#quantumexplorer) | [17](#quantumexplorer-open) | [4](#quantumexplorer-clean) | — | [3](#quantumexplorer-unresolved-comments) | — | — | [2](#quantumexplorer-draft) | [8](#quantumexplorer-stale) | [3](#quantumexplorer-needs-action) | — | [21](#quantumexplorer-unresolved-comments) | [2](#quantumexplorer-ready-for-review) | ↓ 1 |
| [@shumkov](#shumkov) | [10](#shumkov-open) | — | — | [2](#shumkov-unresolved-comments) | — | — | — | [8](#shumkov-stale) | [2](#shumkov-needs-action) | — | [35](#shumkov-unresolved-comments) | [4](#shumkov-ready-for-review) | — |
...
| [@ZocoLini](#zocolini) | [7](#zocolini-open) | — | [1](#zocolini-ci-failing) | — | — | — | [6](#zocolini-draft) | — | — | — | [2](#zocolini-unresolved-comments) | — | ↓ 1 |
...
| [@DCG-Claude](#dcg-claude) | [18](#dcg-claude-open) | — | — | — | — | — | — | [18](#dcg-claude-stale) | — | [9](#dcg-claude-ready-for-human) | [5](#dcg-claude-unresolved-comments) | — | — |
...
#### Ready for Review (1)
- [dashpay/platform#5008 fix(rs-sdk-ffi): stop probing google.com and testnet quorums on every SDK build](https://github.com/dashpay/platform/pull/5008) — by @QuantumExplorer · areas: rust-sdk-ffi, fallback · Policy: waiting-bots
...
- [dashpay/grovedb#977 fix(storage-flags): accept only canonical multi-epoch flag bytes](https://github.com/dashpay/grovedb/pull/977) — 1 unresolved (1 bot) · 9 days stale · ⚠ merge conflict · areas: grovedb · Policy: waiting-author
  ...
  - Blocker: thepastaclaw left review threads unresolved; resolve them
  - Blocker: Proceeded without coderabbitai: it reported a rate limit and did not return
- [dashpay/grovedb#995 perf!: borrow the pending batch when building delete operations](https://github.com/dashpay/grovedb/pull/995) — areas: grovedb · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#4986 fix(drive-abci)!: pay every reward share of a masternode and credit each identity once in the epoch payout (PV15)](https://github.com/dashpay/platform/pull/4986) — 📝 draft · 🐢 targets v4.3-dev · areas: rs-drive, rs-drive-abci, dpp, fallback · Policy: draft
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/platform#5004 perf(drive): build batch deletes without copying the pending batch](https://github.com/dashpay/platform/pull/5004) — areas: rs-drive · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#5007 feat(platform)!: documents with a time to live, deleted by the platform (PV14)](https://github.com/dashpay/platform/pull/5007) — areas: rs-drive, rs-drive-abci, dpp, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#5008 fix(rs-sdk-ffi): stop probing google.com and testnet quorums on every SDK build](https://github.com/dashpay/platform/pull/5008) — areas: rust-sdk-ffi, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#4973 fix(sdk): bound each DAPI request attempt, including the response body](https://github.com/dashpay/platform/pull/4973) — by @llbartekll · areas: fallback · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed 8442d5850f10d6b8d60fb498606dd8a085f565f3 after bot completion
- [dashpay/platform#5004 perf(drive): build batch deletes without copying the pending batch](https://github.com/dashpay/platform/pull/5004) — by @QuantumExplorer · areas: rs-drive · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#4595 fix(swift-sdk): make a changeset round linear without giving up atomicity](https://github.com/dashpay/platform/pull/4595) — 2 unresolved (2 bot) · 18 days stale · ⚠ merge conflict · ✋ changes requested · areas: swift-sdk · Policy: waiting-author
  ...
  - Blocker: thepastaclaw requested changes on this head; dismiss the review or push a fix
  - Blocker: thepastaclaw left review threads unresolved; resolve them
- [dashpay/platform#4978 fix(sdk): keep the chosen DPNS name across wallet sync](https://github.com/dashpay/platform/pull/4978) — 5 unresolved (5 bot) · 1 days stale · 🔴 CI failing · 🐢 targets v4.3-dev · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, rust-sdk · Policy: waiting-bots
  - Top thread: "🟡 Suggestion: Empty canonical snapshots can incorrectly trust a stale main DPNS name**" — 1 days old
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw left review threads unresolved; resolve them
- [dashpay/platform#4992 feat(swift-sdk): durable wallet presence marker readable while the device is locked](https://github.com/dashpay/platform/pull/4992) — 🐢 targets v4.3-dev · areas: swift-sdk · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
- [dashpay/platform#4997 feat(platform-wallet): invitation claim status for the invitee, idempotent claim](https://github.com/dashpay/platform/pull/4997) — 🐢 targets v4.3-dev · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/rust-dashcore#1065 test(dash-spv): look up quorums the way Platform does, across heights](https://github.com/dashpay/rust-dashcore/pull/1065) — 🔴 CI failing · areas: dash-spv · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed c6df4b77a3dd0f5262c8e89d5ce110777f901035 after bot completion
  - Blocker: Proceeded without coderabbitai: it reported a rate limit and did not return
...
- [dashpay/platform#4719 feat: add the dash-sdk-contract declaration model, grammar and diagnostics](https://github.com/dashpay/platform/pull/4719) — 3 unresolved (3 bot) · 3 days stale · ⚠ merge conflict · 🐢 targets v4.3-dev · areas: fallback · Policy: waiting-author
  ...
  - Blocker: thepastaclaw left review threads unresolved; resolve them
  - Blocker: Proceeded without coderabbitai: no review within the configured window
- [dashpay/platform#4703 fix(platform): resolve fee versions by registered number and price refunds at the storage epoch rate](https://github.com/dashpay/platform/pull/4703) — 1 unresolved (1 bot) · 1 days stale · 🐢 targets v4.3-dev · areas: rs-drive, rs-drive-abci, dpp, fallback · Policy: waiting-author
  - Top thread: "🟡 Suggestion: Mark the Rust source-compatibility changes in release metadata**" — 1 days old
  - Blocker: thepastaclaw left review threads unresolved; resolve them
  - Blocker: Proceeded without coderabbitai: no review within the configured window
- [dashpay/platform#4706 feat(platform)!: require fee history for storage refunds and credit their recorded owners](https://github.com/dashpay/platform/pull/4706) — 1 unresolved (1 bot) · 1 days stale · ✋ changes requested · 🐢 targets v4.3-dev · areas: rs-drive, rs-drive-abci, fallback · Policy: waiting-author
  - Top thread: "🔴 Blocking: Reject missing fee history before committing Drive mutations**" — 1 days old
  - Blocker: thepastaclaw requested changes on this head; dismiss the review or push a fix
  - Blocker: thepastaclaw left review threads unresolved; resolve them
  - Blocker: Proceeded without coderabbitai: no review within the configured window
