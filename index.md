...
---
# PR Hygiene Report
*Last updated: 2026-09-17 12:17 UTC · commit 176b407*

## Summary
- Open PRs: **101** (17 clean · 3 CI failing · 7 changes requested · 14 unresolved comments · 0 deferred · 14 draft · 46 stale)
- PRs needing author action: **26**
- Total unresolved comments: **150**
- dashpay/platform: **50** open (2 clean · 0 CI failing · 1 changes requested · 8 unresolved comments · 0 deferred · 2 draft · 37 stale) · engine: 10 configuration-error · 2 draft · 1 waiting-bots · 37 no verdict
...
- dashpay/tenderdash: **2** open (1 clean · 1 CI failing · 0 changes requested · 0 unresolved comments · 0 deferred · 0 draft · 0 stale) · engine: 2 waiting-bots
...
- dashpay/dash-evo-tool: **16** open (7 clean · 0 CI failing · 4 changes requested · 3 unresolved comments · 0 deferred · 1 draft · 1 stale) · engine: 14 configuration-error · 1 draft · 1 no verdict
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [20+(11)](#pastapastapasta-open) | [0+(6)](#pastapastapasta-clean) | [1+(1)](#pastapastapasta-ci-failing) | [3+(0)](#pastapastapasta-unresolved-comments) | [1+(0)](#pastapastapasta-changes-requested) | — | [2+(2)](#pastapastapasta-draft) | [13+(2)](#pastapastapasta-stale) | [5+(4)](#pastapastapasta-needs-action) | — | [38+(6)](#pastapastapasta-unresolved-comments) | — | ↓ 6 |
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [11+(6)](#lklimek-open) | [3+(1)](#lklimek-clean) | [1+(0)](#lklimek-ci-failing) | [2+(1)](#lklimek-unresolved-comments) | [1+(3)](#lklimek-changes-requested) | — | [1+(0)](#lklimek-draft) | [3+(1)](#lklimek-stale) | [3+(4)](#lklimek-needs-action) | — | [3+(10)](#lklimek-unresolved-comments) | [4+(0)](#lklimek-ready-for-review) | ↑ 3 |
| [@QuantumExplorer](#quantumexplorer) | [13](#quantumexplorer-open) | [1](#quantumexplorer-clean) | — | [3](#quantumexplorer-unresolved-comments) | — | — | [1](#quantumexplorer-draft) | [8](#quantumexplorer-stale) | [3](#quantumexplorer-needs-action) | — | [26](#quantumexplorer-unresolved-comments) | [6](#quantumexplorer-ready-for-review) | ↓ 2 |
| [@llbartekll](#llbartekll) | [5](#llbartekll-open) | — | — | [2](#llbartekll-unresolved-comments) | [1](#llbartekll-changes-requested) | — | [1](#llbartekll-draft) | [1](#llbartekll-stale) | [3](#llbartekll-needs-action) | — | [2](#llbartekll-unresolved-comments) | [1](#llbartekll-ready-for-review) | — |
...
| [@shumkov](#shumkov) | [10](#shumkov-open) | — | — | [1](#shumkov-unresolved-comments) | — | — | — | [9](#shumkov-stale) | [1](#shumkov-needs-action) | — | [54](#shumkov-unresolved-comments) | [3](#shumkov-ready-for-review) | ↓ 2 |
...
- [dashpay/platform#4623 feat(platform-wallet): reserve DashPay payout addresses without Core funding](https://github.com/dashpay/platform/pull/4623) — 5 unresolved (4 human, 1 bot) · 9 days stale · ✋ changes requested · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk · Policy: configuration-error
  - Top thread: "Blocking: does not compile against current `v4.2-dev`. After the rust-dashcore bump `Mnemonic::from_phrase` takes one ar…" — 0 days old
...
- [dashpay/platform#4632 feat(sdk)!: pure DPNS and DashPay document builders shared with embedders](https://github.com/dashpay/platform/pull/4632) — 2 unresolved (2 bot) · 6 days stale · ✋ changes requested · areas: rust-sdk, fallback · Policy: configuration-error
  ...
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4392 perf(swift-sdk): linear wallet-changeset rounds via per-round bulk-prefetch cache](https://github.com/dashpay/platform/pull/4392) — 1 unresolved (1 bot) · 8 days stale · ⚠ merge conflict · ✋ changes requested · areas: swift-sdk · Policy: configuration-error
...
- [dashpay/dash-evo-tool#980 feat(identity): add wallet-derived keys to existing identities](https://github.com/dashpay/dash-evo-tool/pull/980) — 📝 draft · areas: dash-evo-tool · Policy: draft
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/dash-evo-tool#987 fix(wallet): single source of truth for wallet and key names](https://github.com/dashpay/dash-evo-tool/pull/987) — via @Claudius-Maginificent · ✋ changes requested · areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
...
- [dashpay/dash-evo-tool#991 fix(dashpay): accept HASH160 profile authentication keys](https://github.com/dashpay/dash-evo-tool/pull/991) — areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#994 fix(wallet): make incompatible-data guidance and upgrade backups safe](https://github.com/dashpay/dash-evo-tool/pull/994) — via @Claudius-Maginificent · ✋ changes requested · areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#996 fix(masternodes): keep the Add-voting-key prompt through unrelated task results](https://github.com/dashpay/dash-evo-tool/pull/996) — via @Claudius-Maginificent · ✋ changes requested · areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4764 fix(platform-wallet): select available signing keys across identity operations](https://github.com/dashpay/platform/pull/4764) — ✋ changes requested · 🐢 targets v4.3-dev · areas: rs-platform-wallet
...
- [dashpay/platform#4798 feat(platform)!: allow authentication keys with a budget and an expiry](https://github.com/dashpay/platform/pull/4798) — 5 unresolved (5 CodeRabbit) · 0 days stale · areas: rs-drive, rs-drive-abci, dpp, rs-platform-wallet, fallback · Policy: configuration-error
...
- [dashpay/platform#4793 feat(platform)!: allow authentication keys bound to a contract group](https://github.com/dashpay/platform/pull/4793) — areas: rs-drive, rs-drive-abci, dpp, rs-platform-wallet-ffi, swift-sdk, kotlin-sdk, fallback · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
...
- [dashpay/platform#3560 test(swift-sdk): add testnet identity-discovery UI test](https://github.com/dashpay/platform/pull/3560) — 1 unresolved (1 bot) · 108 days stale · ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · areas: swift-sdk, fallback · Policy: configuration-error
  ...
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4797 fix(sdk): retry DPNS broadcasts when owner identity is missing](https://github.com/dashpay/platform/pull/4797) — 1 unresolved (1 human) · 0 days stale · areas: rust-sdk · Policy: configuration-error
  - Top thread: "Major (not a blocker).** This bans the responding node for a *deterministic, node-independent* consensus rejection. `Ide…" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4799 fix(sdk): fetch and persist managed identity credit balances](https://github.com/dashpay/platform/pull/4799) — 🔴 CI failing · 🐢 targets codex/dpns-registration-retry-sdk · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk
...
#### Ready for Review (1)
- [dashpay/platform#4793 feat(platform)!: allow authentication keys bound to a contract group](https://github.com/dashpay/platform/pull/4793) — by @QuantumExplorer · areas: rs-drive, rs-drive-abci, dpp, rs-platform-wallet-ffi, swift-sdk, kotlin-sdk, fallback · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
