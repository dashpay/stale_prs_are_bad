...
---
# PR Hygiene Report
*Last updated: 2026-09-18 18:38 UTC · commit 6d2fffb*

## Summary
- Open PRs: **100** (15 clean · 4 CI failing · 3 changes requested · 18 unresolved comments · 0 deferred · 15 draft · 45 stale)
- PRs needing author action: **26**
- Total unresolved comments: **160**
- dashpay/platform: **49** open (0 clean · 1 CI failing · 0 changes requested · 9 unresolved comments · 0 deferred · 3 draft · 36 stale) · engine: 3 draft · 10 waiting-bots · 36 no verdict
...
- dashpay/dash-evo-tool: **15** open (6 clean · 0 CI failing · 1 changes requested · 6 unresolved comments · 0 deferred · 1 draft · 1 stale) · engine: 1 draft · 12 waiting-bots · 1 waiting-self-review · 1 no verdict
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [10+(6)](#lklimek-open) | [1+(1)](#lklimek-clean) | [1+(0)](#lklimek-ci-failing) | [4+(2)](#lklimek-unresolved-comments) | [0+(1)](#lklimek-changes-requested) | — | [1+(0)](#lklimek-draft) | [3+(2)](#lklimek-stale) | [4+(3)](#lklimek-needs-action) | — | [13+(12)](#lklimek-unresolved-comments) | [4+(0)](#lklimek-ready-for-review) | ↑ 4 |
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [20+(11)](#pastapastapasta-open) | [0+(6)](#pastapastapasta-clean) | [1+(1)](#pastapastapasta-ci-failing) | [5+(0)](#pastapastapasta-unresolved-comments) | — | — | [2+(2)](#pastapastapasta-draft) | [12+(2)](#pastapastapasta-stale) | [6+(4)](#pastapastapasta-needs-action) | — | [40+(6)](#pastapastapasta-unresolved-comments) | — | ↓ 5 |
| [@llbartekll](#llbartekll) | [5](#llbartekll-open) | — | — | [2](#llbartekll-unresolved-comments) | [1](#llbartekll-changes-requested) | — | [2](#llbartekll-draft) | — | [3](#llbartekll-needs-action) | — | [6](#llbartekll-unresolved-comments) | — | ↑ 1 |
| [@QuantumExplorer](#quantumexplorer) | [12](#quantumexplorer-open) | — | [1](#quantumexplorer-ci-failing) | [2](#quantumexplorer-unresolved-comments) | — | — | [1](#quantumexplorer-draft) | [8](#quantumexplorer-stale) | [2](#quantumexplorer-needs-action) | — | [18](#quantumexplorer-unresolved-comments) | [5](#quantumexplorer-ready-for-review) | ↓ 3 |
...
- [dashpay/platform#4740 fix(platform-wallet): scan DashPay contact accounts from request height](https://github.com/dashpay/platform/pull/4740) — 3 unresolved (3 bot) · 3 days stale · areas: rs-platform-wallet, swift-sdk · Policy: waiting-bots
  ...
  - Blocker: Bot review threads remain unresolved
- [dashpay/dash-evo-tool#983 test(migration): add cross-version migration test matrix](https://github.com/dashpay/dash-evo-tool/pull/983) — via @Claudius-Maginificent · 1 unresolved (1 CodeRabbit) · 7 days stale · areas: dash-evo-tool · Policy: waiting-bots
  - Top thread: "_🩺 Stability & Availability_ \| _🟠 Major_ \| _🏗️ Heavy lift_" — 7 days old
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: Bot review threads remain unresolved
- [dashpay/dash-evo-tool#994 fix(wallet): make incompatible-data guidance and upgrade backups safe](https://github.com/dashpay/dash-evo-tool/pull/994) — via @Claudius-Maginificent · 2 unresolved (2 CodeRabbit) · 0 days stale · ✋ changes requested · areas: dash-evo-tool · Policy: waiting-bots
...
- [dashpay/platform#4562 ci: build release SDKs and NPM packages on self-hosted runners](https://github.com/dashpay/platform/pull/4562) — 7 unresolved (5 CodeRabbit, 2 bot) · 17 days stale · areas: swift-sdk, fallback · Policy: waiting-bots
...
- [dashpay/platform#4823 feat(swift-example-app): share a bounded login key with a browser over Bluetooth](https://github.com/dashpay/platform/pull/4823) — 🔴 CI failing · areas: swift-sdk · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
