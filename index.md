...
---
# PR Hygiene Report
*Last updated: 2026-09-24 06:20 UTC · commit 5b60ca8*

## Summary
- Open PRs: **90** (13 clean · 4 CI failing · 1 changes requested · 18 unresolved comments · 0 deferred · 15 draft · 39 stale)
- PRs needing author action: **24**
- Total unresolved comments: **145**
- dashpay/platform: **48** open (3 clean · 0 CI failing · 0 changes requested · 10 unresolved comments · 0 deferred · 3 draft · 32 stale) · engine: 14 draft · 2 ready-to-merge · 21 waiting-author · 5 waiting-bots · 2 waiting-self-review · 4 no verdict
- dashpay/rust-dashcore: **27** open (2 clean · 3 CI failing · 1 changes requested · 4 unresolved comments · 0 deferred · 12 draft · 5 stale) · engine: 15 draft · 3 waiting-author · 7 waiting-self-review · 2 no verdict
...
- dashpay/dash-evo-tool: **13** open (7 clean · 1 CI failing · 0 changes requested · 3 unresolved comments · 0 deferred · 0 draft · 2 stale) · engine: 1 ready-for-human · 1 ready-to-merge · 4 waiting-author · 2 waiting-bots · 2 waiting-self-review · 3 no verdict
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [21+(8)](#pastapastapasta-open) | [3+(2)](#pastapastapasta-clean) | [1+(2)](#pastapastapasta-ci-failing) | [8+(0)](#pastapastapasta-unresolved-comments) | — | — | [2+(2)](#pastapastapasta-draft) | [7+(2)](#pastapastapasta-stale) | [9+(2)](#pastapastapasta-needs-action) | — | [41+(6)](#pastapastapasta-unresolved-comments) | — | — |
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [9+(7)](#lklimek-open) | [4+(2)](#lklimek-clean) | [1+(0)](#lklimek-ci-failing) | [2+(1)](#lklimek-unresolved-comments) | — | — | — | [2+(4)](#lklimek-stale) | [3+(2)](#lklimek-needs-action) | [0+(2)](#lklimek-ready-for-human) | [21+(11)](#lklimek-unresolved-comments) | [3+(0)](#lklimek-ready-for-review) | ↓ 3 |
| [@QuantumExplorer](#quantumexplorer) | [12](#quantumexplorer-open) | — | — | [3](#quantumexplorer-unresolved-comments) | — | — | [2](#quantumexplorer-draft) | [7](#quantumexplorer-stale) | [3](#quantumexplorer-needs-action) | — | [21](#quantumexplorer-unresolved-comments) | [4](#quantumexplorer-ready-for-review) | ↑ 1 |
...
| [@shumkov](#shumkov) | [9](#shumkov-open) | — | — | [1](#shumkov-unresolved-comments) | — | — | — | [8](#shumkov-stale) | [1](#shumkov-needs-action) | — | [34](#shumkov-unresolved-comments) | [4](#shumkov-ready-for-review) | — |
...
- [dashpay/platform#4538 fix(sdk): honor explicit regtest addresses in dapi-client; tolerate empty discovery in wasm-sdk trusted context](https://github.com/dashpay/platform/pull/4538) — 2 unresolved (2 bot) · 25 days stale · ⚠ merge conflict · 📝 draft · areas: js-wasm-sdk, fallback · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/platform#4562 ci: build release SDKs and NPM packages on self-hosted runners](https://github.com/dashpay/platform/pull/4562) — 2 unresolved (2 CodeRabbit) · 23 days stale · areas: swift-sdk, fallback · Policy: waiting-author
...
- [dashpay/platform#4963 feat(sdk): reject response metadata from an unexpected chain id](https://github.com/dashpay/platform/pull/4963) — areas: rust-sdk · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#4964 fix(sdk): don't panic in DapiClient::new on an empty address list](https://github.com/dashpay/platform/pull/4964) — areas: fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#4965 test(sdk): cargo-fuzz harness over drive-proof-verifier FromProof](https://github.com/dashpay/platform/pull/4965) — areas: fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/rust-dashcore#752 fix(ffi): validate account seed lengths](https://github.com/dashpay/rust-dashcore/pull/752) — via @thepastaclaw · ⚠ merge conflict · 🔴 CI failing · areas: fallback · Policy: waiting-self-review
...
- [dashpay/platform#4777 fix(platform-wallet)!: preserve Core wallet snapshots on restart](https://github.com/dashpay/platform/pull/4777) — 7 unresolved (7 bot) · 5 days stale · ⚠ merge conflict · 📝 draft · 🐢 targets v4.3-dev · areas: rs-platform-wallet, wallet-storage, fallback · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/dash-evo-tool#976 fix(security): protect identity keys before import storage](https://github.com/dashpay/dash-evo-tool/pull/976) — 1 unresolved (1 bot) · 1 days stale · ✋ changes requested · areas: dash-evo-tool
  - Top thread: "🔴 Blocking: Validate legacy key format after applying replacement keys**" — 1 days old
- [dashpay/dash-evo-tool#994 fix(wallet): make incompatible-data guidance and upgrade backups safe](https://github.com/dashpay/dash-evo-tool/pull/994) — via @Claudius-Maginificent · 1 unresolved (1 bot) · 1 days stale · 🔴 CI failing · areas: dash-evo-tool · Policy: waiting-author
...
- [dashpay/platform#4740 fix(platform-wallet): rescan DashPay contact accounts from the contact request height](https://github.com/dashpay/platform/pull/4740) — 1 unresolved (1 bot) · 0 days stale · 🐢 targets v4.3-dev · areas: rs-platform-wallet, fallback · Policy: waiting-bots
  - Top thread: "🟡 Suggestion: Complete the sent sweep before testing registration's rescan guard**" — 0 days old
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw left review threads unresolved; resolve them
...
- [dashpay/dash-evo-tool#859 perf: detect system theme off UI thread](https://github.com/dashpay/dash-evo-tool/pull/859) — by @thepastaclaw · areas: dash-evo-tool · Policy: waiting-author
  - Blocker: thepastaclaw left review threads unresolved; resolve them
  - Blocker: Proceeded without coderabbitai: no review within the configured window
- [dashpay/platform#4963 feat(sdk): reject response metadata from an unexpected chain id](https://github.com/dashpay/platform/pull/4963) — by @PastaPastaPasta · areas: rust-sdk · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#3417 feat(swift-sdk): use SPV-synced quorums for Platform proof verification](https://github.com/dashpay/platform/pull/3417) — 3 unresolved (3 bot) · 15 days stale · ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · 🐢 targets v4.3-dev · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, rust-sdk, rust-sdk-ffi, fallback · Policy: waiting-author
  ...
  - Blocker: thepastaclaw left review threads unresolved; resolve them
  - Blocker: Proceeded without coderabbitai: no review within the configured window
- [dashpay/platform#4760 feat(platform)!: token shielded pools](https://github.com/dashpay/platform/pull/4760) — 3 unresolved (3 human) · 2 days stale · ⚠ merge conflict · ✋ changes requested · areas: rs-drive, rs-drive-abci, dpp, rust-sdk, fallback · Policy: waiting-bots
...
#### Ready for Review (4)
- [dashpay/platform#4964 fix(sdk): don't panic in DapiClient::new on an empty address list](https://github.com/dashpay/platform/pull/4964) — by @PastaPastaPasta · areas: fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#4965 test(sdk): cargo-fuzz harness over drive-proof-verifier FromProof](https://github.com/dashpay/platform/pull/4965) — by @PastaPastaPasta · areas: fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
