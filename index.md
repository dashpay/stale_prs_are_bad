...
---
# PR Hygiene Report
*Last updated: 2026-09-15 12:17 UTC · commit a66177d*

## Summary
- Open PRs: **118** (19 clean · 8 CI failing · 7 changes requested · 36 unresolved comments · 5 deferred · 32 draft · 11 stale)
- PRs needing author action: **52**
- Total unresolved comments: **193**
- dashpay/platform: **67** open (8 clean · 4 CI failing · 4 changes requested · 26 unresolved comments · 5 deferred · 13 draft · 7 stale) · engine: 14 draft · 30 waiting-bots · 4 waiting-self-review · 8 waiting-slot · 11 no verdict
...
- dashpay/dash-evo-tool: **15** open (7 clean · 0 CI failing · 1 changes requested · 5 unresolved comments · 0 deferred · 1 draft · 1 stale) · engine: 1 draft · 13 waiting-bots · 1 no verdict
...
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [8+(6)](#lklimek-open) | [1+(1)](#lklimek-clean) | [1+(0)](#lklimek-ci-failing) | [2+(3)](#lklimek-unresolved-comments) | [1+(0)](#lklimek-changes-requested) | — | [2+(2)](#lklimek-draft) | [1+(0)](#lklimek-stale) | [4+(3)](#lklimek-needs-action) | — | [3+(17)](#lklimek-unresolved-comments) | [6+(0)](#lklimek-ready-for-review) | ↑ 1 |
| [@shumkov](#shumkov) | [13](#shumkov-open) | [1](#shumkov-clean) | — | [4](#shumkov-unresolved-comments) | [3](#shumkov-changes-requested) | [2](#shumkov-deferred) | [3](#shumkov-draft) | — | [7](#shumkov-needs-action) | — | [54](#shumkov-unresolved-comments) | [5](#shumkov-ready-for-review) | ↑ 4 |
| [@QuantumExplorer](#quantumexplorer) | [12](#quantumexplorer-open) | [1](#quantumexplorer-clean) | [1](#quantumexplorer-ci-failing) | [3](#quantumexplorer-unresolved-comments) | [1](#quantumexplorer-changes-requested) | [2](#quantumexplorer-deferred) | [2](#quantumexplorer-draft) | [2](#quantumexplorer-stale) | [4](#quantumexplorer-needs-action) | — | [25](#quantumexplorer-unresolved-comments) | [7](#quantumexplorer-ready-for-review) | — |
...
| [@ZocoLini](#zocolini) | [13](#zocolini-open) | [1](#zocolini-clean) | [2](#zocolini-ci-failing) | [1](#zocolini-unresolved-comments) | [1](#zocolini-changes-requested) | — | [7](#zocolini-draft) | [1](#zocolini-stale) | [2](#zocolini-needs-action) | — | [10](#zocolini-unresolved-comments) | [4](#zocolini-ready-for-review) | ↑ 2 |
...
- [dashpay/platform#4623 feat(platform-wallet): reserve DashPay payout addresses without Core funding](https://github.com/dashpay/platform/pull/4623) — 1 unresolved (1 bot) · 7 days stale · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk · Policy: waiting-slot
  ...
  - Blocker: Waiting for one of five author review slots
- [dashpay/platform#4539 fix(dashmate): generate release seeds and complete missing node identities](https://github.com/dashpay/platform/pull/4539) — 1 unresolved (1 bot) · 6 days stale · areas: dashmate, fallback · Policy: waiting-bots
...
- [dashpay/dash-evo-tool#851 fix(ui): center text inside buttons with min_size across the app](https://github.com/dashpay/dash-evo-tool/pull/851) — 2 unresolved (2 bot) · 143 days stale · ⚠ merge conflict · areas: dash-evo-tool · Policy: waiting-bots
  ...
  - Blocker: thepastaclaw has not reported for the current head
  - Blocker: Bot review threads remain unresolved
- [dashpay/dash-evo-tool#987 fix(wallet): single source of truth for wallet and key names](https://github.com/dashpay/dash-evo-tool/pull/987) — via @Claudius-Maginificent · 2 unresolved (2 bot) · 0 days stale · ⚠ merge conflict · areas: dash-evo-tool · Policy: waiting-bots
  - Top thread: "🟡 Suggestion: Alias changes leave just-in-time prompt metadata stale**" — 0 days old
  - Blocker: Bot review threads remain unresolved
- [dashpay/dash-evo-tool#983 test(migration): add cross-version migration test matrix](https://github.com/dashpay/dash-evo-tool/pull/983) — via @Claudius-Maginificent · 1 unresolved (1 CodeRabbit) · 4 days stale · ✋ changes requested · areas: dash-evo-tool · Policy: waiting-bots
...
- [dashpay/platform#4661 build(dashmate): update Tenderdash image to 1.8.0-dev.3](https://github.com/dashpay/platform/pull/4661) — via @Claudius-Maginificent · 1 unresolved (1 bot) · 4 days stale · ✋ changes requested · areas: dashmate · Policy: waiting-bots
  ...
  - Blocker: Bot changes request remains outstanding
  - Blocker: Bot review threads remain unresolved
- [dashpay/dash-evo-tool#991 fix(dashpay): accept HASH160 profile authentication keys](https://github.com/dashpay/dash-evo-tool/pull/991) — 1 unresolved (1 CodeRabbit) · 0 days stale · 🔴 CI failing · areas: dash-evo-tool · Policy: waiting-bots
...
- [dashpay/dash-evo-tool#993 chore(deps): update compatible dependencies](https://github.com/dashpay/dash-evo-tool/pull/993) — via @Claudius-Maginificent · areas: dash-evo-tool · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
- [dashpay/platform#4740 fix(platform-wallet): scan DashPay contact accounts from request height](https://github.com/dashpay/platform/pull/4740) — 📝 draft · areas: rs-platform-wallet, rs-platform-wallet-ffi, wallet-storage, swift-sdk · Policy: draft
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/platform#4764 fix(platform-wallet): select available DashPay profile signing keys](https://github.com/dashpay/platform/pull/4764) — 🔴 CI failing · areas: rs-platform-wallet, fallback · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
...
- [dashpay/platform#4283 fix(dashmate): keep the node up when an image pull fails, and stop reporting success when it did not](https://github.com/dashpay/platform/pull/4283) — 2 unresolved (2 bot) · 9 days stale · ⚠ merge conflict · ✋ changes requested · areas: dashmate · Policy: waiting-bots
  ...
  - Blocker: Bot changes request remains outstanding
  - … 1 more blocker(s)
- [dashpay/platform#2392 feat(dashmate): single node local network [WIP\]](https://github.com/dashpay/platform/pull/2392) — 📝 draft · ⏸ deferred · areas: dashmate, js-wasm-sdk, fallback
...
- [dashpay/platform#3417 feat(swift-sdk): use SPV-synced quorums for Platform proof verification](https://github.com/dashpay/platform/pull/3417) — 5 unresolved (5 bot) · 7 days stale · ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, rust-sdk, rust-sdk-ffi, fallback · Policy: waiting-bots
  ...
  - Blocker: Bot changes request remains outstanding
  - … 1 more blocker(s)
- [dashpay/platform#4760 feat(platform)!: token shielded pools](https://github.com/dashpay/platform/pull/4760) — 6 unresolved (6 bot) · 0 days stale · ✋ changes requested · 🔴 CI failing · areas: rs-drive, rs-drive-abci, dpp, rust-sdk, fallback · Policy: waiting-bots
...
- [dashpay/platform#1834 feat(drive-abci)!: Statesync](https://github.com/dashpay/platform/pull/1834) — 📝 draft · ⏸ deferred · areas: rs-drive, rs-drive-abci, dpp, rust-sdk, dashmate, js-wasm-sdk, system-contracts, fallback
...
- [dashpay/platform#4651 fix(platform-wallet): resolve a swept sent payment's verdict on the round that swept it](https://github.com/dashpay/platform/pull/4651) — areas: rs-platform-wallet, wallet-storage, fallback · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed a57bfbf31c3e9d66c4750e0455ca27d2cf157ce0 after bot completion
- [dashpay/platform#4659 fix(platform-wallet): give an unconfirmed outgoing send an owner across a restart](https://github.com/dashpay/platform/pull/4659) — ⚠ merge conflict · 🔴 CI failing · areas: rs-platform-wallet, rs-platform-wallet-ffi, wallet-storage, swift-sdk, fallback · Policy: waiting-bots
  - Blocker: thepastaclaw has not reported for the current head
- [dashpay/platform#4738 fix(platform-wallet): look up the funding tx's block when a ChainLock proof has no record height](https://github.com/dashpay/platform/pull/4738) — 🔴 CI failing · areas: rs-platform-wallet, rust-sdk, fallback · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
...
#### Open (13)
- [dashpay/rust-dashcore#496 Refactor/transaction builder](https://github.com/dashpay/rust-dashcore/pull/496) — 8 unresolved (8 CodeRabbit) · 194 days stale · ⚠ merge conflict · 📝 draft · areas: key-wallet, key-wallet-manager, fallback · ⚠ ownership unresolved: key-wallet, key-wallet-manager · Policy: draft
  - Top thread: "_⚠️ Potential issue_ \| _🔴 Critical_" — 194 days old
  - Blocker: Draft PR does not occupy a review slot
...
- [dashpay/rust-dashcore#370 Refactor: config builder to ensure validation](https://github.com/dashpay/rust-dashcore/pull/370) — ⚠ merge conflict · 📝 draft · areas: dash-spv, fallback · ⚠ ownership unresolved: dash-spv · Policy: draft
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/rust-dashcore#374 Feat: config can be built from any json reader](https://github.com/dashpay/rust-dashcore/pull/374) — ⚠ merge conflict · 📝 draft · 🐢 targets refacor/config-builder, untouched 238 days · areas: dash-spv · ⚠ ownership unresolved: dash-spv
...
#### Open (1)
- [dashpay/platform#2486 feat(drive-abci): state sync - faster sync of new nodes](https://github.com/dashpay/platform/pull/2486) — ⏸ deferred · areas: rs-drive, rs-drive-abci, dpp, dashmate, fallback
