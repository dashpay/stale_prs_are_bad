...
---
# PR Hygiene Report
*Last updated: 2026-09-15 18:13 UTC · commit c115fa4*

## Summary
- Open PRs: **112** (21 clean · 6 CI failing · 7 changes requested · 41 unresolved comments · 0 deferred · 28 draft · 9 stale)
- PRs needing author action: **56**
- Total unresolved comments: **205**
- dashpay/platform: **62** open (8 clean · 4 CI failing · 4 changes requested · 28 unresolved comments · 0 deferred · 12 draft · 6 stale) · engine: 17 configuration-error · 12 draft · 16 waiting-bots · 2 waiting-self-review · 9 waiting-slot · 6 no verdict
...
- dashpay/dash-evo-tool: **19** open (8 clean · 0 CI failing · 1 changes requested · 7 unresolved comments · 0 deferred · 2 draft · 1 stale) · engine: 15 configuration-error · 2 draft · 1 waiting-slot · 1 no verdict
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [@PastaPastaPasta + (@thepastaclaw)](#pastapastapasta) | [24+(12)](#pastapastapasta-open) | [2+(7)](#pastapastapasta-clean) | [1+(1)](#pastapastapasta-ci-failing) | [11+(1)](#pastapastapasta-unresolved-comments) | — | — | [5+(2)](#pastapastapasta-draft) | [5+(1)](#pastapastapasta-stale) | [12+(6)](#pastapastapasta-needs-action) | — | [57+(6)](#pastapastapasta-unresolved-comments) | — | ↑ 3 |
| [@lklimek + (@Claudius-Maginificent)](#lklimek) | [9+(9)](#lklimek-open) | [1+(2)](#lklimek-clean) | — | [4+(5)](#lklimek-unresolved-comments) | [1+(0)](#lklimek-changes-requested) | — | [2+(2)](#lklimek-draft) | [1+(0)](#lklimek-stale) | [5+(5)](#lklimek-needs-action) | — | [8+(31)](#lklimek-unresolved-comments) | [6+(0)](#lklimek-ready-for-review) | ↑ 2 |
| [@shumkov](#shumkov) | [11](#shumkov-open) | [1](#shumkov-clean) | — | [4](#shumkov-unresolved-comments) | [3](#shumkov-changes-requested) | — | [3](#shumkov-draft) | — | [7](#shumkov-needs-action) | — | [54](#shumkov-unresolved-comments) | [5](#shumkov-ready-for-review) | ↑ 4 |
| [@QuantumExplorer](#quantumexplorer) | [11](#quantumexplorer-open) | [1](#quantumexplorer-clean) | [2](#quantumexplorer-ci-failing) | [3](#quantumexplorer-unresolved-comments) | [1](#quantumexplorer-changes-requested) | — | [2](#quantumexplorer-draft) | [2](#quantumexplorer-stale) | [4](#quantumexplorer-needs-action) | — | [29](#quantumexplorer-unresolved-comments) | [8](#quantumexplorer-ready-for-review) | — |
| [@HashEngineering](#hashengineering) | [5](#hashengineering-open) | — | — | [3](#hashengineering-unresolved-comments) | — | — | [2](#hashengineering-draft) | — | [3](#hashengineering-needs-action) | — | [4](#hashengineering-unresolved-comments) | [2](#hashengineering-ready-for-review) | ↑ 2 |
...
| [@romchornyi](#romchornyi) | [6](#romchornyi-open) | [3](#romchornyi-clean) | [2](#romchornyi-ci-failing) | [1](#romchornyi-unresolved-comments) | — | — | — | — | [3](#romchornyi-needs-action) | — | [2](#romchornyi-unresolved-comments) | [2](#romchornyi-ready-for-review) | — |
...
- [dashpay/platform#4573 feat(drive-abci): debug-only per-block phase timing](https://github.com/dashpay/platform/pull/4573) — 8 unresolved (5 human, 3 bot) · 7 days stale · ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · areas: rs-drive-abci · Policy: waiting-slot
...
- [dashpay/platform#4530 test(dashmate): live state sync e2e — join tooling, churn, re-sync and fallback coverage](https://github.com/dashpay/platform/pull/4530) — 6 unresolved (6 bot) · 16 days stale · ⚠ merge conflict · 📝 draft · areas: rs-drive, rs-drive-abci, dpp, dashmate, js-wasm-sdk, fallback · Policy: draft
...
- [dashpay/platform#4562 ci: build release SDKs and NPM packages on self-hosted runners](https://github.com/dashpay/platform/pull/4562) — 4 unresolved (3 CodeRabbit, 1 bot) · 14 days stale · 🔴 CI failing · areas: fallback · Policy: waiting-bots
...
- [dashpay/rust-dashcore#901 fix(key-wallet): discover Coinbase/AssetUnlock outputs for all fund-bearing accounts](https://github.com/dashpay/rust-dashcore/pull/901) — via @thepastaclaw · 2 unresolved (2 CodeRabbit) · 40 days stale · ⚠ merge conflict · ✋ changes requested · 📝 draft · areas: dash-spv, key-wallet · ⚠ ownership unresolved: dash-spv, key-wallet · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/platform#4521 feat(dashmate): state sync configuration for tenderdash and drive snapshots](https://github.com/dashpay/platform/pull/4521) — 2 unresolved (2 bot) · 16 days stale · 📝 draft · areas: dashmate · Policy: draft
...
- [dashpay/platform#4538 fix(sdk): honor explicit regtest addresses in dapi-client; tolerate empty discovery in wasm-sdk trusted context](https://github.com/dashpay/platform/pull/4538) — 2 unresolved (2 bot) · 16 days stale · 📝 draft · areas: js-wasm-sdk, fallback · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/platform#4648 feat(drive-abci)!: state sync via ABCI snapshots with reduced platform state (protocol v15)](https://github.com/dashpay/platform/pull/4648) — 3 unresolved (3 bot) · 5 days stale · ⚠ merge conflict · 🔴 CI failing · areas: rs-drive, rs-drive-abci, dpp, fallback · Policy: waiting-slot
...
- [dashpay/platform#4632 feat(sdk)!: pure DPNS and DashPay document builders shared with embedders](https://github.com/dashpay/platform/pull/4632) — 2 unresolved (2 bot) · 4 days stale · areas: rust-sdk, fallback · Policy: waiting-slot
  ...
  - Blocker: Waiting for one of five author review slots
- [dashpay/platform#4623 feat(platform-wallet): reserve DashPay payout addresses without Core funding](https://github.com/dashpay/platform/pull/4623) — 1 unresolved (1 bot) · 7 days stale · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk · Policy: waiting-slot
  - Top thread: "🟡 Suggestion: Exercise overlapping persistence to protect the new payment gate**" — 7 days old
  - Blocker: Waiting for one of five author review slots
- [dashpay/platform#4539 fix(dashmate): generate release seeds and complete missing node identities](https://github.com/dashpay/platform/pull/4539) — 1 unresolved (1 bot) · 7 days stale · areas: dashmate, fallback · Policy: waiting-bots
  - Top thread: "🔴 Blocking: Avoid ranking bootstrap peers by operator-grindable node IDs**" — 7 days old
  - Blocker: coderabbitai has not reported for the current head
  - Blocker: thepastaclaw has not reported for the current head
  - Blocker: Bot changes request remains outstanding
  - … 1 more blocker(s)
...
- [dashpay/dash-evo-tool#859 perf: detect system theme off UI thread](https://github.com/dashpay/dash-evo-tool/pull/859) — via @thepastaclaw · areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4136 fix(dashmate): use live Tenderdash app version for protocol status](https://github.com/dashpay/platform/pull/4136) — via @thepastaclaw · ⚠ merge conflict · areas: dashmate · Policy: waiting-bots
  - Blocker: coderabbitai has not reported for the current head
...
- [dashpay/platform#3992 feat(platform-wallet): manifest integrity checksum (Risk-6/R12.5 follow-up)](https://github.com/dashpay/platform/pull/3992) — via @Claudius-Maginificent · 4 unresolved (4 bot) · 74 days stale · ⚠ merge conflict · ✋ changes requested · 📝 draft · areas: rs-platform-wallet, wallet-storage, fallback · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/dash-evo-tool#983 test(migration): add cross-version migration test matrix](https://github.com/dashpay/dash-evo-tool/pull/983) — via @Claudius-Maginificent · 7 unresolved (1 CodeRabbit, 6 bot) · 4 days stale · ✋ changes requested · areas: dash-evo-tool · Policy: configuration-error
  - Top thread: "_🩺 Stability & Availability_ \| _🟠 Major_ \| _🏗️ Heavy lift_" — 4 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#851 fix(ui): center text inside buttons with min_size across the app](https://github.com/dashpay/dash-evo-tool/pull/851) — 2 unresolved (2 bot) · 143 days stale · ⚠ merge conflict · areas: dash-evo-tool · Policy: configuration-error
  - Top thread: "🟡 Suggestion: Add a kittest harness for the new add_sized button-sizing contract**" — 143 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#994 fix(wallet): make incompatible-data guidance and upgrade backups safe](https://github.com/dashpay/dash-evo-tool/pull/994) — via @Claudius-Maginificent · 7 unresolved (1 CodeRabbit, 1 human, 5 bot) · 0 days stale · ✋ changes requested · areas: dash-evo-tool · Policy: configuration-error
  - Top thread: "we need a defense-in-depth to ensure the selected file is really a backup, not the actual pre-migration or post-migratio…" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4740 fix(platform-wallet): scan DashPay contact accounts from request height](https://github.com/dashpay/platform/pull/4740) — 4 unresolved (2 CodeRabbit, 2 bot) · 0 days stale · areas: rs-platform-wallet, swift-sdk · Policy: configuration-error
  - Top thread: "_🎯 Functional Correctness_ \| _🟡 Minor_ \| _⚡ Quick win_" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#987 fix(wallet): single source of truth for wallet and key names](https://github.com/dashpay/dash-evo-tool/pull/987) — via @Claudius-Maginificent · 2 unresolved (2 bot) · 0 days stale · ⚠ merge conflict · areas: dash-evo-tool · Policy: configuration-error
  - Top thread: "🟡 Suggestion: Alias changes leave just-in-time prompt metadata stale**" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4661 build(dashmate): update Tenderdash image to 1.8.0-dev.3](https://github.com/dashpay/platform/pull/4661) — via @Claudius-Maginificent · 1 unresolved (1 bot) · 4 days stale · ✋ changes requested · areas: dashmate · Policy: waiting-bots
  ...
  - Blocker: Bot changes request remains outstanding
  - Blocker: Bot review threads remain unresolved
- [dashpay/dash-evo-tool#991 fix(dashpay): accept HASH160 profile authentication keys](https://github.com/dashpay/dash-evo-tool/pull/991) — 1 unresolved (1 CodeRabbit) · 0 days stale · areas: dash-evo-tool · Policy: configuration-error
  - Top thread: "_🎯 Functional Correctness_ \| _🟡 Minor_ \| _⚡ Quick win_" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#995 chore(deps)!: bump major-version dependencies (egui 0.36, crypto, rmcp 3.3, ...)](https://github.com/dashpay/dash-evo-tool/pull/995) — via @Claudius-Maginificent · 1 unresolved (1 CodeRabbit) · 0 days stale · 🔴 CI failing · areas: dash-evo-tool · Policy: configuration-error
  - Top thread: "_🎯 Functional Correctness_ \| _🟡 Minor_ \| _⚡ Quick win_" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4764 fix(platform-wallet): select available DashPay profile signing keys](https://github.com/dashpay/platform/pull/4764) — 1 unresolved (1 bot) · 0 days stale · 🔴 CI failing · areas: rs-platform-wallet, fallback · Policy: configuration-error
  - Top thread: "🟡 Suggestion: Signer availability callback runs while holding the wallet manager read guard**" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#901 feat(dpns): unify safe masternode voting operations](https://github.com/dashpay/dash-evo-tool/pull/901) — areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#976 fix(security): protect identity keys before import storage](https://github.com/dashpay/dash-evo-tool/pull/976) — ✋ changes requested · 🔴 CI failing · areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
...
- [dashpay/dash-evo-tool#993 chore(deps): update compatible dependencies](https://github.com/dashpay/dash-evo-tool/pull/993) — via @Claudius-Maginificent · areas: dash-evo-tool · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/dash-evo-tool#996 fix(masternodes): keep the Add-voting-key prompt through unrelated task results](https://github.com/dashpay/dash-evo-tool/pull/996) — via @Claudius-Maginificent · areas: dash-evo-tool · Policy: waiting-slot
  - Blocker: Waiting for one of five author review slots
...
- [dashpay/rust-dashcore#634 feat(key-wallet-manager): single-map WalletManager with Arc<RwLock<T>> per wallet](https://github.com/dashpay/rust-dashcore/pull/634) — 20 unresolved (20 CodeRabbit) · 160 days stale · ⚠ merge conflict · ✋ changes requested · areas: dash-spv, key-wallet, key-wallet-manager, fallback · ⚠ ownership unresolved: dash-spv, key-wallet, key-wallet-manager · Policy: configuration-error
  ...
  - Blocker: Unresolved identities in dash-spv
- [dashpay/dash-evo-tool#890 test(masternode-upgrade): standalone masternode-identity upgrade harness + spec](https://github.com/dashpay/dash-evo-tool/pull/890) — 24 unresolved (20 human, 4 bot) · 60 days stale · ✋ changes requested · areas: dash-evo-tool · Policy: configuration-error
  ...
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4282 fix(dashmate)!: give Debian packages versions apt can order](https://github.com/dashpay/platform/pull/4282) — 6 unresolved (1 CodeRabbit, 5 bot) · 15 days stale · ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · areas: dashmate, js-wasm-sdk, system-contracts, fallback · Policy: waiting-bots
...
- [dashpay/platform#3936 chore(drive-abci): update to nested address in SML](https://github.com/dashpay/platform/pull/3936) — 2 unresolved (2 bot) · 88 days stale · ⚠ merge conflict · 📝 draft · areas: rs-drive-abci, rust-sdk, fallback · Policy: draft
  ...
  - Blocker: Draft PR does not occupy a review slot
- [dashpay/platform#4283 fix(dashmate): keep the node up when an image pull fails, and stop reporting success when it did not](https://github.com/dashpay/platform/pull/4283) — 2 unresolved (2 bot) · 9 days stale · ⚠ merge conflict · ✋ changes requested · areas: dashmate · Policy: waiting-bots
...
- [dashpay/platform#4636 fix(platform-wallet): close the asset-lock resume broadcast race](https://github.com/dashpay/platform/pull/4636) — areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, kotlin-sdk · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4652 feat(drive)!: preserve composite document history across protocol activation](https://github.com/dashpay/platform/pull/4652) — ✋ changes requested · areas: rs-drive, rs-drive-abci, rust-sdk, js-wasm-sdk, fallback · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4657 feat(platform)!: delete and erase lifecycle for keep-history documents](https://github.com/dashpay/platform/pull/4657) — ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · areas: rs-drive, rs-drive-abci, dpp, rust-sdk, js-wasm-sdk, fallback · Policy: configuration-error
  - Blocker: An assigned owner/reviewer lacks verified write access
...
- [dashpay/platform#3417 feat(swift-sdk): use SPV-synced quorums for Platform proof verification](https://github.com/dashpay/platform/pull/3417) — 5 unresolved (5 bot) · 7 days stale · ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · areas: rs-platform-wallet, rs-platform-wallet-ffi, swift-sdk, rust-sdk, rust-sdk-ffi, fallback · Policy: configuration-error
  ...
  - Blocker: An assigned owner/reviewer lacks verified write access
- [dashpay/platform#4760 feat(platform)!: token shielded pools](https://github.com/dashpay/platform/pull/4760) — 6 unresolved (6 bot) · 0 days stale · ✋ changes requested · 🔴 CI failing · areas: rs-drive, rs-drive-abci, dpp, rust-sdk, fallback · Policy: configuration-error
  - Top thread: "🟡 Suggestion: The shielded-pool setter creates a second representation of an unpooled token**" — 0 days old
  - Blocker: An assigned owner/reviewer lacks verified write access
...
- [dashpay/platform#4730 feat(platform)!: delta-based data contract update transition for protocol version 15](https://github.com/dashpay/platform/pull/4730) — 4 unresolved (4 bot) · 0 days stale · ✋ changes requested · 🔴 CI failing · 🐢 targets v4.3-dev · areas: rs-drive, rs-drive-abci, dpp, rs-platform-wallet, fallback
  - Top thread: "🔴 Blocking: Do not modify the frozen v0 contract-update state validator for V1 rejection**" — 0 days old
...
- [dashpay/platform#4751 ci: drop stale coverage objects before the Rust workspace test step](https://github.com/dashpay/platform/pull/4751) — areas: fallback · Policy: waiting-self-review
  - Blocker: Author must post /self-reviewed 02984cb3e6a643ceca5475f9ce4e9a3b38511b65 after bot completion
- [dashpay/platform#4766 perf(wasm-sdk): fetch quorums concurrently and skip masternode discovery when addresses are given](https://github.com/dashpay/platform/pull/4766) — 🔴 CI failing · areas: js-wasm-sdk, fallback · Policy: waiting-slot
  - Blocker: Waiting for one of five author review slots
...
#### Open (5)
- [dashpay/platform#4759 fix(kotlin-sdk): skip JReleaser's POM lint, which rejects Android's aar packaging](https://github.com/dashpay/platform/pull/4759) — 2 unresolved (2 bot) · 0 days stale · areas: kotlin-sdk · Policy: waiting-bots
  - Top thread: "🟡 Suggestion: Clarify the validations that remain active for AAR publishing**" — 0 days old
  - Blocker: Bot review threads remain unresolved
- [dashpay/platform#4643 fix(sdk)!: keep Keystore's unlocked-device gate from bricking wallets and signing on defective OEM builds](https://github.com/dashpay/platform/pull/4643) — 1 unresolved (1 bot) · 1 days stale · 🔴 CI failing · areas: kotlin-sdk · Policy: waiting-bots
...
- [dashpay/rust-dashcore#375 refactor(dash-spv): checkpoint rewrite](https://github.com/dashpay/rust-dashcore/pull/375) — 2 unresolved (2 CodeRabbit) · 237 days stale · ⚠ merge conflict · areas: dash-spv, fallback · ⚠ ownership unresolved: dash-spv · Policy: configuration-error
  ...
  - Blocker: Unresolved identities in dash-spv
- [dashpay/rust-dashcore#1015 fix(key-wallet): re-apply a spend whose coin was funded after it](https://github.com/dashpay/rust-dashcore/pull/1015) — 2 unresolved (2 CodeRabbit) · 0 days stale · ✋ changes requested · 🔴 CI failing · areas: dash-spv, key-wallet, key-wallet-manager · ⚠ ownership unresolved: dash-spv, key-wallet, key-wallet-manager · Policy: configuration-error
...
#### Open (6)
- [dashpay/platform#4595 fix(swift-sdk): make a changeset round linear without giving up atomicity](https://github.com/dashpay/platform/pull/4595) — 2 unresolved (2 bot) · 8 days stale · ⚠ merge conflict · ✋ changes requested · areas: swift-sdk · Policy: configuration-error
...
#### Open (3)
- [dashpay/platform#3560 test(swift-sdk): add testnet identity-discovery UI test](https://github.com/dashpay/platform/pull/3560) — 1 unresolved (1 bot) · 106 days stale · ⚠ merge conflict · ✋ changes requested · 🔴 CI failing · areas: swift-sdk, fallback · Policy: configuration-error
